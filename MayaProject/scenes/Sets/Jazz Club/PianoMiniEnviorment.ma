...
//Last modified: Tue, Oct 28, 2025 08:35:17 PM
//Codeset: 1252
...
fileInfo "UUID" "64B0CC92-4690-C7B1-EF2E-69827BB5AB66";
createNode transform -s -n "persp";
	rename -uid "6D126645-4C7F-2A57-E537-CCAAEA974817";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -13.534265936880665 6.782251527285613 -3.745488372232181 ;
	setAttr ".r" -type "double3" -27.338352729910362 1362.9999999997874 -7.0694371510985737e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "83AE5728-4713-AEC0-70D9-438AA2373A55";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 20.717499238175385;
