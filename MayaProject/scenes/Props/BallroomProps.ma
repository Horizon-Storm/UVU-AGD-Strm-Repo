...
//Last modified: Sun, Sep 21, 2025 12:10:25 PM
//Codeset: 1252
...
fileInfo "UUID" "1D582132-4BB8-1785-F544-E3AF56DF8B1A";
createNode transform -s -n "persp";
	rename -uid "6A31553E-489A-3CF8-57D5-FA990D67763A";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 31.020972867410482 38.176670039228256 76.01457357731833 ;
	setAttr ".r" -type "double3" -24.938352729602403 22.200000000000045 -1.7176021863337543e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "6BEA5ABD-45DA-3857-7692-699315CB3EE5";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 90.542665573011703;
...
createNode transform -n "imagePlane4" -p "Piano";
	...
	setAttr ".t" -type "double3" 13.453306742644905 5.851819819615967 0 ;
...
createNode transform -n "imagePlane5" -p "Piano";
	...
	setAttr ".t" -type "double3" 16.489096789684218 0 0 ;
...
createNode imagePlane -n "imagePlaneShape5" -p "imagePlane5";
	...
	setAttr -k off ".v";
	setAttr ".fc" 127;
	setAttr ".imn" -type "string" "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//Reference Images/Piano2.jpg";
	setAttr ".cov" -type "short2" 214 235 ;
	setAttr ".dlc" no;
	setAttr ".w" 2.14;
	setAttr ".h" 2.35;
	setAttr ".cs" -type "string" "sRGB";
createNode transform -n "imagePlane6" -p "Piano";
	...
	setAttr ".t" -type "double3" 24.403736068032572 0 0 ;
	setAttr ".s" -type "double3" 1.3819554124980389 1.3819554124980389 1.3819554124980389 ;
createNode imagePlane -n "imagePlaneShape6" -p "imagePlane6";
	rename -uid "25BC8F59-436D-39F6-9A54-F1A9CC4079FA";
	setAttr -k off ".v";
	setAttr ".fc" 127;
	setAttr ".imn" -type "string" "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//Reference Images/Piano 3.jpg";
	setAttr ".cov" -type "short2" 1300 1060 ;
	setAttr ".dlc" no;
	setAttr ".w" 13;
	setAttr ".h" 10.6;
	setAttr ".cs" -type "string" "sRGB";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "5DDE5481-4121-67D4-B639-BCBA91C4F8EE";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "28163890-428B-BC19-C49A-0F897F06FF6C";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "A71D4941-4383-4071-17AB-E0A6F7108FAC";
createNode displayLayerManager -n "layerManager";
	rename -uid "DCF7B575-406D-637B-F925-D2857E9EEA5B";
createNode displayLayer -n "defaultLayer";
	rename -uid "393B9EB1-40BC-D697-FB44-A3AEAAFB0D95";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "A3288A8A-4B4F-03BA-FB79-059EAFC0C754";
