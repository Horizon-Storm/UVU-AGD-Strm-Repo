...
//Name: PianoMiniEnviorment.ma
//Last modified: Tue, Oct 28, 2025 08:21:38 PM
//Codeset: 1252
...
fileInfo "UUID" "3DB00F08-4202-9048-24D4-A1918026F9D3";
createNode transform -s -n "persp";
	rename -uid "6D126645-4C7F-2A57-E537-CCAAEA974817";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -52.291966211490468 11.343128342671015 -8.2987467239771746 ;
	setAttr ".r" -type "double3" -5.1383527294327704 1349.7999999999872 -1.0177774980683254e-13 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "83AE5728-4713-AEC0-70D9-438AA2373A55";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 60.660023776878255;
...
createNode transform -n "Piano";
	...
	setAttr ".t" -type "double3" -5.9231822855601282 0 5.7548045575551914 ;
...
createNode transform -n "MainCam";
	...
	setAttr ".t" -type "double3" -44.418441353759142 18.164850476498174 -1.3382523031293934 ;
	setAttr ".r" -type "double3" -13.538352729613473 -87.799999999994611 4.9711949033680159e-13 ;
...
createNode camera -n "MainCamShape" -p "MainCam";
	...
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 50.366019715560689;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "9ADB37FD-4343-BA9B-5E73-93A558FFDC86";
	setAttr -s 24 ".lnk";
	setAttr -s 3 ".ign";
	setAttr -s 24 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "93F2A704-4812-AC52-438A-CC9DE595C059";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "C87ADD6A-4297-0976-903E-019B98F0A04A";
createNode displayLayerManager -n "layerManager";
	rename -uid "A66B03E7-40FF-0238-E10C-7194B80B40A8";
createNode displayLayer -n "defaultLayer";
	rename -uid "00F1608C-4B93-1752-5E9D-73B3BB786956";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "98BA4645-4492-B8DC-EB55-F182B3D7F4F7";
...
createNode substanceNode -n "substanceNode1";
	...
	addAttr -r false -ci true -h true -k true -sn "input_colorr" -ln "input_colorR" 
		-dv 0.59195399284362793 -smn 0 -smx 1 -at "float" -p "input_color";
	addAttr -r false -ci true -h true -k true -sn "input_colorg" -ln "input_colorG" 
		-dv 0.49522501230239868 -smn 0 -smx 1 -at "float" -p "input_color";
	addAttr -r false -ci true -h true -k true -sn "input_colorb" -ln "input_colorB" 
		-dv 0.38091000914573669 -smn 0 -smx 1 -at "float" -p "input_color";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "799AF670-4226-B9C1-1DCD-6B919CE740A3";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -1283.1323264460229 -7860.1377945484119 ;
	setAttr ".tgi[0].vh" -type "double2" 134.74033940634968 -6944.9780621324344 ;
	setAttr -s 108 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" -2877.142822265625;
	setAttr ".tgi[0].ni[0].y" -1251.4285888671875;
	setAttr ".tgi[0].ni[0].nvs" 1923;
	setAttr ".tgi[0].ni[1].x" -2484.28564453125;
	setAttr ".tgi[0].ni[1].y" -3772.857177734375;
	setAttr ".tgi[0].ni[1].nvs" 1971;
	setAttr ".tgi[0].ni[2].x" -2877.142822265625;
	setAttr ".tgi[0].ni[2].y" -1427.142822265625;
	setAttr ".tgi[0].ni[2].nvs" 1923;
	setAttr ".tgi[0].ni[3].x" -3421.428466796875;
	setAttr ".tgi[0].ni[3].y" -7011.4287109375;
	setAttr ".tgi[0].ni[3].nvs" 1923;
	setAttr ".tgi[0].ni[4].x" -2772.857177734375;
	setAttr ".tgi[0].ni[4].y" -7835.71435546875;
	setAttr ".tgi[0].ni[4].nvs" 1923;
	setAttr ".tgi[0].ni[5].x" -2795.71435546875;
	setAttr ".tgi[0].ni[5].y" -6671.4287109375;
	setAttr ".tgi[0].ni[5].nvs" 1923;
	setAttr ".tgi[0].ni[6].x" -2441.428466796875;
	setAttr ".tgi[0].ni[6].y" -7658.5712890625;
	setAttr ".tgi[0].ni[6].nvs" 1971;
	setAttr ".tgi[0].ni[7].x" -2834.28564453125;
	setAttr ".tgi[0].ni[7].y" -6204.28564453125;
	setAttr ".tgi[0].ni[7].nvs" 1923;
	setAttr ".tgi[0].ni[8].x" -3215.71435546875;
	setAttr ".tgi[0].ni[8].y" -2624.28564453125;
	setAttr ".tgi[0].ni[8].nvs" 1923;
	setAttr ".tgi[0].ni[9].x" -2834.28564453125;
	setAttr ".tgi[0].ni[9].y" -5700;
	setAttr ".tgi[0].ni[9].nvs" 1923;
	setAttr ".tgi[0].ni[10].x" -2452.857177734375;
	setAttr ".tgi[0].ni[10].y" -6641.4287109375;
	setAttr ".tgi[0].ni[10].nvs" 1971;
	setAttr ".tgi[0].ni[11].x" -2945.71435546875;
	setAttr ".tgi[0].ni[11].y" -361.42855834960938;
	setAttr ".tgi[0].ni[11].nvs" 1923;
	setAttr ".tgi[0].ni[12].x" -2834.28564453125;
	setAttr ".tgi[0].ni[12].y" -6051.4287109375;
	setAttr ".tgi[0].ni[12].nvs" 1923;
	setAttr ".tgi[0].ni[13].x" -2478.571533203125;
	setAttr ".tgi[0].ni[13].y" -5164.28564453125;
	setAttr ".tgi[0].ni[13].nvs" 1923;
	setAttr ".tgi[0].ni[14].x" -2858.571533203125;
	setAttr ".tgi[0].ni[14].y" -3608.571533203125;
	setAttr ".tgi[0].ni[14].nvs" 1923;
	setAttr ".tgi[0].ni[15].x" -2471.428466796875;
	setAttr ".tgi[0].ni[15].y" -5570;
	setAttr ".tgi[0].ni[15].nvs" 1971;
	setAttr ".tgi[0].ni[16].x" -2167.142822265625;
	setAttr ".tgi[0].ni[16].y" -5320;
	setAttr ".tgi[0].ni[16].nvs" 1923;
	setAttr ".tgi[0].ni[17].x" -2141.428466796875;
	setAttr ".tgi[0].ni[17].y" -6984.28564453125;
	setAttr ".tgi[0].ni[17].nvs" 1923;
	setAttr ".tgi[0].ni[18].x" -2795.71435546875;
	setAttr ".tgi[0].ni[18].y" -6824.28564453125;
	setAttr ".tgi[0].ni[18].nvs" 1923;
	setAttr ".tgi[0].ni[19].x" -3208.571533203125;
	setAttr ".tgi[0].ni[19].y" -4088.571533203125;
	setAttr ".tgi[0].ni[19].nvs" 1923;
	setAttr ".tgi[0].ni[20].x" -2527.142822265625;
	setAttr ".tgi[0].ni[20].y" -324.28570556640625;
	setAttr ".tgi[0].ni[20].nvs" 1971;
	setAttr ".tgi[0].ni[21].x" -2130;
	setAttr ".tgi[0].ni[21].y" -8512.857421875;
	setAttr ".tgi[0].ni[21].nvs" 1923;
	setAttr ".tgi[0].ni[22].x" -2858.571533203125;
	setAttr ".tgi[0].ni[22].y" -3784.28564453125;
	setAttr ".tgi[0].ni[22].nvs" 1923;
	setAttr ".tgi[0].ni[23].x" -2174.28564453125;
	setAttr ".tgi[0].ni[23].y" -2418.571533203125;
	setAttr ".tgi[0].ni[23].nvs" 1923;
	setAttr ".tgi[0].ni[24].x" -2945.71435546875;
	setAttr ".tgi[0].ni[24].y" -712.85711669921875;
	setAttr ".tgi[0].ni[24].nvs" 1923;
	setAttr ".tgi[0].ni[25].x" -2945.71435546875;
	setAttr ".tgi[0].ni[25].y" -888.5714111328125;
	setAttr ".tgi[0].ni[25].nvs" 1923;
	setAttr ".tgi[0].ni[26].x" -2862.857177734375;
	setAttr ".tgi[0].ni[26].y" -2487.142822265625;
	setAttr ".tgi[0].ni[26].nvs" 1923;
	setAttr ".tgi[0].ni[27].x" -3522.857177734375;
	setAttr ".tgi[0].ni[27].y" -2758.571533203125;
	setAttr ".tgi[0].ni[27].nvs" 1923;
	setAttr ".tgi[0].ni[28].x" -2167.142822265625;
	setAttr ".tgi[0].ni[28].y" -5144.28564453125;
	setAttr ".tgi[0].ni[28].nvs" 1923;
	setAttr ".tgi[0].ni[29].x" -2834.28564453125;
	setAttr ".tgi[0].ni[29].y" -5524.28564453125;
	setAttr ".tgi[0].ni[29].nvs" 1923;
	setAttr ".tgi[0].ni[30].x" -3480;
	setAttr ".tgi[0].ni[30].y" -5891.4287109375;
	setAttr ".tgi[0].ni[30].nvs" 1923;
	setAttr ".tgi[0].ni[31].x" -2862.857177734375;
	setAttr ".tgi[0].ni[31].y" -2662.857177734375;
	setAttr ".tgi[0].ni[31].nvs" 1923;
	setAttr ".tgi[0].ni[32].x" -2160;
	setAttr ".tgi[0].ni[32].y" -5882.85693359375;
	setAttr ".tgi[0].ni[32].nvs" 1923;
	setAttr ".tgi[0].ni[33].x" -2858.571533203125;
	setAttr ".tgi[0].ni[33].y" -4311.4287109375;
	setAttr ".tgi[0].ni[33].nvs" 1923;
	setAttr ".tgi[0].ni[34].x" -2877.142822265625;
	setAttr ".tgi[0].ni[34].y" -1602.857177734375;
	setAttr ".tgi[0].ni[34].nvs" 1923;
	setAttr ".tgi[0].ni[35].x" -2160;
	setAttr ".tgi[0].ni[35].y" -6424.28564453125;
	setAttr ".tgi[0].ni[35].nvs" 1923;
	setAttr ".tgi[0].ni[36].x" -2848.571533203125;
	setAttr ".tgi[0].ni[36].y" -5230;
	setAttr ".tgi[0].ni[36].nvs" 1923;
	setAttr ".tgi[0].ni[37].x" -2848.571533203125;
	setAttr ".tgi[0].ni[37].y" -5054.28564453125;
	setAttr ".tgi[0].ni[37].nvs" 1923;
	setAttr ".tgi[0].ni[38].x" -2181.428466796875;
	setAttr ".tgi[0].ni[38].y" -1864.2857666015625;
	setAttr ".tgi[0].ni[38].nvs" 1923;
	setAttr ".tgi[0].ni[39].x" -2441.428466796875;
	setAttr ".tgi[0].ni[39].y" -8331.4287109375;
	setAttr ".tgi[0].ni[39].nvs" 1923;
	setAttr ".tgi[0].ni[40].x" -2181.428466796875;
	setAttr ".tgi[0].ni[40].y" -2040;
	setAttr ".tgi[0].ni[40].nvs" 1923;
	setAttr ".tgi[0].ni[41].x" -3388.571533203125;
	setAttr ".tgi[0].ni[41].y" -7945.71435546875;
	setAttr ".tgi[0].ni[41].nvs" 1923;
	setAttr ".tgi[0].ni[42].x" -3194.28564453125;
	setAttr ".tgi[0].ni[42].y" -4735.71435546875;
	setAttr ".tgi[0].ni[42].nvs" 1923;
	setAttr ".tgi[0].ni[43].x" -2772.857177734375;
	setAttr ".tgi[0].ni[43].y" -8340;
	setAttr ".tgi[0].ni[43].nvs" 1923;
	setAttr ".tgi[0].ni[44].x" -2174.28564453125;
	setAttr ".tgi[0].ni[44].y" -2594.28564453125;
	setAttr ".tgi[0].ni[44].nvs" 1923;
	setAttr ".tgi[0].ni[45].x" -2945.71435546875;
	setAttr ".tgi[0].ni[45].y" -185.71427917480469;
	setAttr ".tgi[0].ni[45].nvs" 1923;
	setAttr ".tgi[0].ni[46].x" -2862.857177734375;
	setAttr ".tgi[0].ni[46].y" -3167.142822265625;
	setAttr ".tgi[0].ni[46].nvs" 1923;
	setAttr ".tgi[0].ni[47].x" -3114.28564453125;
	setAttr ".tgi[0].ni[47].y" -6628.5712890625;
	setAttr ".tgi[0].ni[47].nvs" 1923;
	setAttr ".tgi[0].ni[48].x" -2492.857177734375;
	setAttr ".tgi[0].ni[48].y" -1957.142822265625;
	setAttr ".tgi[0].ni[48].nvs" 1923;
	setAttr ".tgi[0].ni[49].x" -2130;
	setAttr ".tgi[0].ni[49].y" -8287.142578125;
	setAttr ".tgi[0].ni[49].nvs" 1923;
	setAttr ".tgi[0].ni[50].x" -3340;
	setAttr ".tgi[0].ni[50].y" -675.71429443359375;
	setAttr ".tgi[0].ni[50].nvs" 1923;
	setAttr ".tgi[0].ni[51].x" -2848.571533203125;
	setAttr ".tgi[0].ni[51].y" -4550;
	setAttr ".tgi[0].ni[51].nvs" 1923;
	setAttr ".tgi[0].ni[52].x" -2492.857177734375;
	setAttr ".tgi[0].ni[52].y" -1227.142822265625;
	setAttr ".tgi[0].ni[52].nvs" 1971;
	setAttr ".tgi[0].ni[53].x" -2485.71435546875;
	setAttr ".tgi[0].ni[53].y" -2468.571533203125;
	setAttr ".tgi[0].ni[53].nvs" 1923;
	setAttr ".tgi[0].ni[54].x" -2858.571533203125;
	setAttr ".tgi[0].ni[54].y" -4135.71435546875;
	setAttr ".tgi[0].ni[54].nvs" 1923;
	setAttr ".tgi[0].ni[55].x" -3081.428466796875;
	setAttr ".tgi[0].ni[55].y" -7811.4287109375;
	setAttr ".tgi[0].ni[55].nvs" 1923;
	setAttr ".tgi[0].ni[56].x" -2181.428466796875;
	setAttr ".tgi[0].ni[56].y" -1570;
	setAttr ".tgi[0].ni[56].nvs" 1923;
	setAttr ".tgi[0].ni[57].x" -2862.857177734375;
	setAttr ".tgi[0].ni[57].y" -2815.71435546875;
	setAttr ".tgi[0].ni[57].nvs" 1923;
	setAttr ".tgi[0].ni[58].x" -2772.857177734375;
	setAttr ".tgi[0].ni[58].y" -7660;
	setAttr ".tgi[0].ni[58].nvs" 1923;
	setAttr ".tgi[0].ni[59].x" -2452.857177734375;
	setAttr ".tgi[0].ni[59].y" -7371.4287109375;
	setAttr ".tgi[0].ni[59].nvs" 1923;
	setAttr ".tgi[0].ni[60].x" -2174.28564453125;
	setAttr ".tgi[0].ni[60].y" -2242.857177734375;
	setAttr ".tgi[0].ni[60].nvs" 1923;
	setAttr ".tgi[0].ni[61].x" -3172.857177734375;
	setAttr ".tgi[0].ni[61].y" -5881.4287109375;
	setAttr ".tgi[0].ni[61].nvs" 1923;
	setAttr ".tgi[0].ni[62].x" -2172.857177734375;
	setAttr ".tgi[0].ni[62].y" -3370;
	setAttr ".tgi[0].ni[62].nvs" 1923;
	setAttr ".tgi[0].ni[63].x" -2172.857177734375;
	setAttr ".tgi[0].ni[63].y" -3721.428466796875;
	setAttr ".tgi[0].ni[63].nvs" 1923;
	setAttr ".tgi[0].ni[64].x" -2141.428466796875;
	setAttr ".tgi[0].ni[64].y" -7454.28564453125;
	setAttr ".tgi[0].ni[64].nvs" 1923;
	setAttr ".tgi[0].ni[65].x" -2795.71435546875;
	setAttr ".tgi[0].ni[65].y" -7408.5712890625;
	setAttr ".tgi[0].ni[65].nvs" 1923;
	setAttr ".tgi[0].ni[66].x" -2130;
	setAttr ".tgi[0].ni[66].y" -7972.85693359375;
	setAttr ".tgi[0].ni[66].nvs" 1923;
	setAttr ".tgi[0].ni[67].x" -2215.71435546875;
	setAttr ".tgi[0].ni[67].y" -245.71427917480469;
	setAttr ".tgi[0].ni[67].nvs" 1923;
	setAttr ".tgi[0].ni[68].x" -3515.71435546875;
	setAttr ".tgi[0].ni[68].y" -3848.571533203125;
	setAttr ".tgi[0].ni[68].nvs" 1923;
	setAttr ".tgi[0].ni[69].x" -2471.428466796875;
	setAttr ".tgi[0].ni[69].y" -6242.85693359375;
	setAttr ".tgi[0].ni[69].nvs" 1923;
	setAttr ".tgi[0].ni[70].x" -3501.428466796875;
	setAttr ".tgi[0].ni[70].y" -4994.28564453125;
	setAttr ".tgi[0].ni[70].nvs" 1923;
	setAttr ".tgi[0].ni[71].x" -2848.571533203125;
	setAttr ".tgi[0].ni[71].y" -4725.71435546875;
	setAttr ".tgi[0].ni[71].nvs" 1923;
	setAttr ".tgi[0].ni[72].x" -2772.857177734375;
	setAttr ".tgi[0].ni[72].y" -8164.28564453125;
	setAttr ".tgi[0].ni[72].nvs" 1923;
	setAttr ".tgi[0].ni[73].x" -2877.142822265625;
	setAttr ".tgi[0].ni[73].y" -1778.5714111328125;
	setAttr ".tgi[0].ni[73].nvs" 1923;
	setAttr ".tgi[0].ni[74].x" -2167.142822265625;
	setAttr ".tgi[0].ni[74].y" -4805.71435546875;
	setAttr ".tgi[0].ni[74].nvs" 1923;
	setAttr ".tgi[0].ni[75].x" -3647.142822265625;
	setAttr ".tgi[0].ni[75].y" -560;
	setAttr ".tgi[0].ni[75].nvs" 1923;
	setAttr ".tgi[0].ni[76].x" -3544.28564453125;
	setAttr ".tgi[0].ni[76].y" -1710;
	setAttr ".tgi[0].ni[76].nvs" 1923;
	setAttr ".tgi[0].ni[77].x" -2877.142822265625;
	setAttr ".tgi[0].ni[77].y" -1988.5714111328125;
	setAttr ".tgi[0].ni[77].nvs" 1923;
	setAttr ".tgi[0].ni[78].x" -2945.71435546875;
	setAttr ".tgi[0].ni[78].y" -537.14288330078125;
	setAttr ".tgi[0].ni[78].nvs" 1923;
	setAttr ".tgi[0].ni[79].x" -2141.428466796875;
	setAttr ".tgi[0].ni[79].y" -7278.5712890625;
	setAttr ".tgi[0].ni[79].nvs" 1923;
	setAttr ".tgi[0].ni[80].x" -2862.857177734375;
	setAttr ".tgi[0].ni[80].y" -2991.428466796875;
	setAttr ".tgi[0].ni[80].nvs" 1923;
	setAttr ".tgi[0].ni[81].x" -2858.571533203125;
	setAttr ".tgi[0].ni[81].y" -3960;
	setAttr ".tgi[0].ni[81].nvs" 1923;
	setAttr ".tgi[0].ni[82].x" -2172.857177734375;
	setAttr ".tgi[0].ni[82].y" -3545.71435546875;
	setAttr ".tgi[0].ni[82].nvs" 1923;
	setAttr ".tgi[0].ni[83].x" -2848.571533203125;
	setAttr ".tgi[0].ni[83].y" -4878.5712890625;
	setAttr ".tgi[0].ni[83].nvs" 1923;
	setAttr ".tgi[0].ni[84].x" -2795.71435546875;
	setAttr ".tgi[0].ni[84].y" -7000;
	setAttr ".tgi[0].ni[84].nvs" 1923;
	setAttr ".tgi[0].ni[85].x" -2834.28564453125;
	setAttr ".tgi[0].ni[85].y" -5875.71435546875;
	setAttr ".tgi[0].ni[85].nvs" 1923;
	setAttr ".tgi[0].ni[86].x" -2215.71435546875;
	setAttr ".tgi[0].ni[86].y" -70;
	setAttr ".tgi[0].ni[86].nvs" 1923;
	setAttr ".tgi[0].ni[87].x" -2772.857177734375;
	setAttr ".tgi[0].ni[87].y" -8011.4287109375;
	setAttr ".tgi[0].ni[87].nvs" 1923;
	setAttr ".tgi[0].ni[88].x" -2215.71435546875;
	setAttr ".tgi[0].ni[88].y" -1024.2857666015625;
	setAttr ".tgi[0].ni[88].nvs" 1923;
	setAttr ".tgi[0].ni[89].x" -3237.142822265625;
	setAttr ".tgi[0].ni[89].y" -1700;
	setAttr ".tgi[0].ni[89].nvs" 1923;
	setAttr ".tgi[0].ni[90].x" -2484.28564453125;
	setAttr ".tgi[0].ni[90].y" -3597.142822265625;
	setAttr ".tgi[0].ni[90].nvs" 1923;
	setAttr ".tgi[0].ni[91].x" -2485.71435546875;
	setAttr ".tgi[0].ni[91].y" -2644.28564453125;
	setAttr ".tgi[0].ni[91].nvs" 1971;
	setAttr ".tgi[0].ni[92].x" -2478.571533203125;
	setAttr ".tgi[0].ni[92].y" -4491.4287109375;
	setAttr ".tgi[0].ni[92].nvs" 1971;
	setAttr ".tgi[0].ni[93].x" -2160;
	setAttr ".tgi[0].ni[93].y" -6197.14306640625;
	setAttr ".tgi[0].ni[93].nvs" 1923;
	setAttr ".tgi[0].ni[94].x" -2795.71435546875;
	setAttr ".tgi[0].ni[94].y" -7175.71435546875;
	setAttr ".tgi[0].ni[94].nvs" 1923;
	setAttr ".tgi[0].ni[95].x" -2527.142822265625;
	setAttr ".tgi[0].ni[95].y" -148.57142639160156;
	setAttr ".tgi[0].ni[95].nvs" 1923;
	setAttr ".tgi[0].ni[96].x" -892.85711669921875;
	setAttr ".tgi[0].ni[96].y" -7432.85693359375;
	setAttr ".tgi[0].ni[96].nvs" 1923;
	setAttr ".tgi[0].ni[97].x" -892.85711669921875;
	setAttr ".tgi[0].ni[97].y" -7784.28564453125;
	setAttr ".tgi[0].ni[97].nvs" 1923;
	setAttr ".tgi[0].ni[98].x" -487.14285278320312;
	setAttr ".tgi[0].ni[98].y" -7775.71435546875;
	setAttr ".tgi[0].ni[98].nvs" 1923;
	setAttr ".tgi[0].ni[99].x" -892.85711669921875;
	setAttr ".tgi[0].ni[99].y" -7257.14306640625;
	setAttr ".tgi[0].ni[99].nvs" 1923;
	setAttr ".tgi[0].ni[100].x" -175.71427917480469;
	setAttr ".tgi[0].ni[100].y" -7957.14306640625;
	setAttr ".tgi[0].ni[100].nvs" 1923;
	setAttr ".tgi[0].ni[101].x" -894.821044921875;
	setAttr ".tgi[0].ni[101].y" -7608.5712890625;
	setAttr ".tgi[0].ni[101].nvs" 1923;
	setAttr ".tgi[0].ni[102].x" -1275.7142333984375;
	setAttr ".tgi[0].ni[102].y" -7061.4287109375;
	setAttr ".tgi[0].ni[102].nvs" 1923;
	setAttr ".tgi[0].ni[103].x" -175.71427917480469;
	setAttr ".tgi[0].ni[103].y" -7730;
	setAttr ".tgi[0].ni[103].nvs" 1923;
	setAttr ".tgi[0].ni[104].x" -892.85711669921875;
	setAttr ".tgi[0].ni[104].y" -7104.28564453125;
	setAttr ".tgi[0].ni[104].nvs" 1923;
	setAttr ".tgi[0].ni[105].x" -1582.857177734375;
	setAttr ".tgi[0].ni[105].y" -7444.28564453125;
	setAttr ".tgi[0].ni[105].nvs" 1923;
	setAttr ".tgi[0].ni[106].x" -487.14285278320312;
	setAttr ".tgi[0].ni[106].y" -7102.85693359375;
	setAttr ".tgi[0].ni[106].nvs" 1971;
	setAttr ".tgi[0].ni[107].x" -175.71427917480469;
	setAttr ".tgi[0].ni[107].y" -7417.14306640625;
...
connectAttr "file12.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "Bench_MetalMatPBR.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[1].dn"
		;
connectAttr "file10.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
connectAttr "place2dTexture10.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "file38.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
connectAttr "bump2d9.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
connectAttr "PianoMetalMatPBR.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[6].dn"
		;
connectAttr "file33.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[7].dn"
		;
connectAttr "file23.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[8].dn"
		;
connectAttr "file32.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[9].dn"
		;
connectAttr "PianoWheelsMatPBR.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[10].dn"
		;
connectAttr "file2.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[11].dn"
		;
connectAttr "bump2d6.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[12].dn"
		;
connectAttr "displacementShader5.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[13].dn"
		;
connectAttr "file15.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[14].dn"
		;
connectAttr "PianoMainBodyMatPBR.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[15].dn"
		;
connectAttr "set5.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[16].dn"
		;
connectAttr "set8OPBR_SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[17].dn"
		;
connectAttr "file54.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[18].dn"
		;
connectAttr "file17.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[19].dn"
		;
connectAttr "ChandalierMatPBR.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[20].dn"
		;
connectAttr "file37.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[21].dn"
		;
connectAttr "file16.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[22].dn"
		;
connectAttr "set4.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[23].dn"
		;
connectAttr "file6.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[24].dn"
		;
connectAttr "bump2d1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[25].dn"
		;
connectAttr "file21.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[26].dn"
		;
connectAttr "place2dTexture4.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[27].dn"
		;
connectAttr "file25.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[28].dn"
		;
connectAttr "file34.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[29].dn"
		;
...
connectAttr "bump2d4.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[31].dn"
		;
connectAttr "set6OPBR_SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[32].dn"
		;
connectAttr "bump2d3.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[33].dn"
		;
connectAttr "file8.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[34].dn"
		;
connectAttr "file31.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[35].dn"
		;
connectAttr "file27.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[36].dn"
		;
connectAttr "file30.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[37].dn"
		;
connectAttr "file7.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[38].dn"
		;
connectAttr "displacementShader7.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[39].dn"
		;
connectAttr "set2.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[40].dn"
		;
connectAttr "place2dTexture8.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[41].dn"
		;
connectAttr "file29.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[42].dn"
		;
connectAttr "file39.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[43].dn"
		;
connectAttr "set4OPBR_SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[44].dn"
		;
connectAttr "file3.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[45].dn"
		;
connectAttr "file24.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[46].dn"
		;
connectAttr "file53.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[47].dn"
		;
connectAttr "displacementShader2.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[48].dn"
		;
connectAttr "set7.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[49].dn"
		;
connectAttr "file5.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[50].dn"
		;
connectAttr "file26.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[51].dn"
		;
connectAttr "BenchFabricMatPBR.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[52].dn"
		;
connectAttr "displacementShader4.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[53].dn"
		;
connectAttr "file14.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[54].dn"
		;
connectAttr "file41.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[55].dn"
		;
connectAttr "set2OPBR_SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[56].dn"
		;
connectAttr "file20.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[57].dn"
		;
connectAttr "file40.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[58].dn"
		;
connectAttr "displacementShader8.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[59].dn"
		;
connectAttr "file19.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[60].dn"
		;
connectAttr "file35.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[61].dn"
		;
connectAttr "file13.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[62].dn"
		;
connectAttr "set3OPBR_SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[63].dn"
		;
connectAttr "set8.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[64].dn"
		;
connectAttr "file51.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[65].dn"
		;
connectAttr "set7OPBR_SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[66].dn"
		;
connectAttr "set1OPBR_SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[67].dn"
		;
connectAttr "place2dTexture3.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[68].dn"
		;
connectAttr "displacementShader6.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[69].dn"
		;
connectAttr "place2dTexture5.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[70].dn"
		;
connectAttr "bump2d5.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[71].dn"
		;
connectAttr "file42.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[72].dn"
		;
connectAttr "bump2d2.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[73].dn"
		;
connectAttr "set5OPBR_SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[74].dn"
		;
connectAttr "place2dTexture1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[75].dn"
		;
connectAttr "place2dTexture2.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[76].dn"
		;
connectAttr "file9.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[77].dn"
		;
connectAttr "file4.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[78].dn"
		;
connectAttr "file49.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[79].dn"
		;
connectAttr "file22.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[80].dn"
		;
connectAttr "file18.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[81].dn"
		;
connectAttr "set3.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[82].dn"
		;
connectAttr "file28.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[83].dn"
		;
connectAttr "file52.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[84].dn"
		;
connectAttr "file36.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[85].dn"
		;
connectAttr "set1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[86].dn"
		;
connectAttr "bump2d7.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[87].dn"
		;
connectAttr "file1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[88].dn"
		;
connectAttr "file11.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[89].dn"
		;
connectAttr "displacementShader3.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[90].dn"
		;
connectAttr "BenchBodyMatPBR.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[91].dn"
		;
connectAttr "PianoUnderWoodMatPBR.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[92].dn"
		;
connectAttr "set6.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[93].dn"
		;
connectAttr "file50.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[94].dn"
		;
connectAttr "displacementShader1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[95].dn"
		;
connectAttr "file58.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[96].dn"
		;
connectAttr "file57.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[97].dn"
		;
connectAttr "displacementShader9.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[98].dn"
		;
connectAttr "file60.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[99].dn"
		;
connectAttr "file55.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[100].dn"
		;
connectAttr "file56.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[101].dn"
		;
connectAttr "file59.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[102].dn"
		;
connectAttr "set9.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[103].dn"
		;
connectAttr "bump2d10.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[104].dn"
		;
connectAttr "place2dTexture11.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[105].dn"
		;
connectAttr "GroundMatPBR.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[106].dn"
		;
connectAttr "set9OPBR_SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[107].dn"
		;
