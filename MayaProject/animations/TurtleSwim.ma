...
//Name: TurtleSwim.ma
//Last modified: Sun, Apr 26, 2026 12:44:59 AM
//Codeset: 1252
...
fileInfo "UUID" "9249BF98-446F-2614-47F1-8E849B0D99EA";
createNode transform -s -n "persp";
	rename -uid "D2844BE4-44D6-A210-2CD3-D29458DF4FFD";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 39.738785797088333 30.418199740637469 -2.3880147055691801 ;
	setAttr ".r" -type "double3" -26.999999999999467 89.199999999998681 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 62.189660470804405;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "82EB4B36-4AE2-AF9D-0C91-94BAD414B6C0";
	setAttr -s 28 ".lnk";
	setAttr -s 28 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "EF7822B8-421D-42F2-1F28-CAB0E7827A1A";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 2 1 0 ;
	setAttr -s 2 ".bspr";
	setAttr -s 2 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "29167940-4828-8F64-41CC-019A90DE4769";
createNode displayLayerManager -n "layerManager";
	rename -uid "A25C6E0C-4498-E79B-6D25-B399E5261976";
createNode displayLayer -n "defaultLayer";
	rename -uid "B8CBA738-4932-6C9F-C6CA-358C7AAA2E08";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "1A61B831-4AFC-345F-1648-1989D0B06EA8";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "B93E1F54-43CE-A8A2-A35B-F7BAF5381ADF";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 153.01916187555591 -1483.3332743909648 ;
	setAttr ".tgi[0].vh" -type "double2" 879.12365425363066 -745.23806562499522 ;
	setAttr -s 11 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 588.5714111328125;
	setAttr ".tgi[0].ni[0].y" -518.5714111328125;
	setAttr ".tgi[0].ni[0].nvs" 2066;
	setAttr ".tgi[0].ni[1].x" 327.14285278320312;
	setAttr ".tgi[0].ni[1].y" -1334.2857666015625;
	setAttr ".tgi[0].ni[1].nvs" 1923;
	setAttr ".tgi[0].ni[2].x" 185.71427917480469;
	setAttr ".tgi[0].ni[2].y" -202.85714721679688;
	setAttr ".tgi[0].ni[2].nvs" 1923;
	setAttr ".tgi[0].ni[3].x" 172.21931457519531;
	setAttr ".tgi[0].ni[3].y" -1107.8658447265625;
	setAttr ".tgi[0].ni[3].nvs" 1923;
	setAttr ".tgi[0].ni[4].x" -209.71601867675781;
	setAttr ".tgi[0].ni[4].y" -1033.9886474609375;
	setAttr ".tgi[0].ni[4].nvs" 2387;
	setAttr ".tgi[0].ni[5].x" -24.205646514892578;
	setAttr ".tgi[0].ni[5].y" -825.1689453125;
	setAttr ".tgi[0].ni[5].nvs" 1923;
	setAttr ".tgi[0].ni[6].x" -668.5714111328125;
	setAttr ".tgi[0].ni[6].y" -467.14285278320312;
	setAttr ".tgi[0].ni[6].nvs" 2387;
	setAttr ".tgi[0].ni[7].x" -262.2431640625;
	setAttr ".tgi[0].ni[7].y" -849.123046875;
	setAttr ".tgi[0].ni[7].nvs" 1923;
	setAttr ".tgi[0].ni[8].x" 281.42855834960938;
	setAttr ".tgi[0].ni[8].y" -817.14288330078125;
	setAttr ".tgi[0].ni[8].nvs" 1923;
	setAttr ".tgi[0].ni[9].x" 20;
	setAttr ".tgi[0].ni[9].y" -1334.2857666015625;
...
connectAttr "lambert2SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[1].dn"
		;
connectAttr "aiFog.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
...
connectAttr "file1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
connectAttr "Sea.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[6].dn"
		;
connectAttr "place2dTexture1.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[7].dn"
		;
connectAttr "aiGobo3.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[8].dn"
		;
connectAttr "Sand.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[9].dn"
		;
