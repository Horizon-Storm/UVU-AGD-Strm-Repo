...
//Name: TurnAround.ma
//Last modified: Mon, Nov 17, 2025 03:12:25 PM
//Codeset: 1252
...
fileInfo "UUID" "50AE9282-4EBF-DF74-CDDE-6F832E7C3F66";
createNode transform -s -n "persp";
	rename -uid "09931983-4D12-26EA-F62F-C68A0E86A1FA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 9.7454793445044245 76.40523973869648 -2.1048609058105816 ;
	setAttr ".r" -type "double3" 277.19999999985083 -267.59999999999712 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 20000;
	setAttr ".coi" 72.825371805485346;
...
createNode transform -n "QuartersCam" -p "Cameras";
	...
	setAttr -l on ".t" -type "double3" -16.901547012672914 9.634143098157999 -15.136359810178803 ;
	setAttr -l on ".t";
	setAttr -l on ".r" -type "double3" -22.538352729582012 228.59999999995017 0 ;
	setAttr -l on ".r";
createNode camera -n "QuartersCamShape" -p "QuartersCam";
	...
	setAttr ".fcp" 20000;
	setAttr ".coi" 24.647846605985507;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "2EAF801A-4B76-25C2-1FCE-42A7387293E9";
	setAttr -s 13 ".lnk";
	setAttr -s 13 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "93ED9E0D-4DA5-3356-5045-70B1549CF03B";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "2009E0EE-400B-5989-01B8-BB83E3ECFAF5";
createNode displayLayerManager -n "layerManager";
	rename -uid "D9935D25-4B5C-B9DD-6075-4AA79D0A719D";
createNode displayLayer -n "defaultLayer";
	rename -uid "4A8DD7B2-45E5-17CB-0407-41A17C9826CB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "407875DE-4481-C6DC-AAD3-BFA0261E036B";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "533743E0-4BD1-463D-43AF-8DA0554A5AAB";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -80.952377735622491 -494.0475994159313 ;
	setAttr ".tgi[0].vh" -type "double2" 567.85712029252829 165.47618390075772 ;
