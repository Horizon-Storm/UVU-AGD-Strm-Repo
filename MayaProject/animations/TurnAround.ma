...
//Name: TurnAround.ma
//Last modified: Mon, Nov 17, 2025 03:28:08 PM
//Codeset: 1252
...
fileInfo "UUID" "80093665-4789-067D-6D36-0582A8DFB567";
createNode transform -s -n "persp";
	rename -uid "09931983-4D12-26EA-F62F-C68A0E86A1FA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 21.760509809475536 11.39518517638426 -15.790681031529822 ;
	setAttr ".r" -type "double3" 342.59999999968477 -235.59999999999022 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "1B3410C4-4D25-9A48-B272-1D8446B96E32";
	setAttr -s 26 ".lnk";
	setAttr -s 26 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "48EC65D9-4703-4942-57EC-C588FB445DF5";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "E5C5AC2A-43D7-0C06-B903-3785BEBF57F7";
createNode displayLayerManager -n "layerManager";
	rename -uid "208169F8-4F2D-7396-AB42-2CB6C28BF13A";
createNode displayLayer -n "defaultLayer";
	rename -uid "4A8DD7B2-45E5-17CB-0407-41A17C9826CB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "2D7602E0-4F18-2759-8F91-449EDE4A3547";
