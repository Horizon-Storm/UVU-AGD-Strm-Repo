...
//Last modified: Wed, Mar 04, 2026 04:53:48 PM
//Codeset: 1252
...
fileInfo "UUID" "3CF85BDE-4D55-E01E-AB29-1EAB91DD194C";
createNode transform -s -n "persp";
	rename -uid "109AF7D7-45CE-8F11-6765-DAA873E6C1A8";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -44.560253752483042 14.629164690229613 8.2751573842875867 ;
	setAttr ".r" -type "double3" -6.3383527295749182 -82.999999999996632 3.2622587770991172e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "6E32FA5C-4372-CA15-3309-F6BDB5D14D93";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".fcp" 20000;
	setAttr ".coi" 52.565748761876328;
...
createNode transform -n "MainCam";
	...
	setAttr ".t" -type "double3" -36.223644437079678 11.438217537322428 4.3430613834248506 ;
...
createNode fosterParent -n "Ultimate_Bony_v1_0_5RNfosterParent1";
	rename -uid "3559D2DF-4E58-E1E4-5979-4E865F23F4F5";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "F9B0AD7E-49F8-2359-1FC8-F5A4331D83E4";
	setAttr -s 22 ".lnk";
	setAttr -s 22 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "1AECD4CA-4D1F-966C-DC05-D287E6D67F00";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 2 1 0 ;
	setAttr -s 2 ".bspr";
	setAttr -s 2 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "3F4CFCE0-4290-B8E1-E869-D481C3F1973D";
createNode displayLayerManager -n "layerManager";
	rename -uid "467D6D05-4990-B7A3-7400-B6BF6536677F";
createNode displayLayer -n "defaultLayer";
	rename -uid "CCC49FF2-491B-441B-F8FA-9D89B7FC1262";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0582DF9E-4411-EB2E-50FA-ECB1331D7697";
...
createNode animCurveTA -n "Bony_ROOTC_rotateZ";
	...
	setAttr -s 10 ".ktv[0:9]"  0 0 10 2.9247857240130308 20 -1.5522609160059762
		 30 0.086359892692497664 40 2.0000253749512082 50 -0.9008615774149259 59 -0.31710327525005405
		 65 0 85 0 105 0;
	setAttr -s 10 ".kit[9]"  1;
	setAttr -s 10 ".kot[0:9]"  18 18 18 18 18 18 18 18 
		1 1;
