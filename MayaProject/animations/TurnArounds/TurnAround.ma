...
//Name: TurnAround.ma
//Last modified: Wed, Mar 04, 2026 05:01:43 PM
//Codeset: 1252
...
fileInfo "UUID" "F68BA9F9-46D4-A7EE-DC96-0A87A2CA010B";
...
createNode transform -n "QuartersCam" -p "Cameras";
	...
	setAttr ".t" -type "double3" -10.277528419386032 8.640037081073034 -7.6642356335822734 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "A28012FC-4A37-100D-FAB3-F2801A9259BA";
	setAttr -s 20 ".lnk";
	setAttr -s 20 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "73B87871-47AA-A047-DC8B-D0964CF5D945";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "667F4FD8-477A-B46E-B8FB-A193A0D76671";
createNode displayLayerManager -n "layerManager";
	rename -uid "1DB1DC34-4080-BB8D-D967-909BE89635DE";
createNode displayLayer -n "defaultLayer";
	rename -uid "4A8DD7B2-45E5-17CB-0407-41A17C9826CB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "E6CC4791-4EFF-796A-A57D-8397AA5F180F";
