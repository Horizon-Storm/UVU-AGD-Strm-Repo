...
//Name: BackYardKidTurnAround.ma
//Last modified: Wed, Dec 10, 2025 05:27:53 PM
//Codeset: 1252
file -rdi 1 -ns "BackYardKid_Import" -rfn "BackYardKid_ImportRN" -op "v=0;" 
		-typ "mayaAscii" "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Characters/BackyardKid/BackYardKid_Import.ma";
file -r -ns "BackYardKid_Import" -dr 1 -rfn "BackYardKid_ImportRN" -op "v=0;" -typ
		 "mayaAscii" "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Characters/BackyardKid/BackYardKid_Import.ma";
...
fileInfo "UUID" "E6C11EF5-4D4F-C722-8E98-9C8C7D3B72AC";
createNode transform -s -n "persp";
	rename -uid "09931983-4D12-26EA-F62F-C68A0E86A1FA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 79.46469437515799 24.813274304626031 -29.724398123616471 ;
	setAttr ".r" -type "double3" 345.59999999967982 -249.9999999999871 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 20000;
	setAttr ".coi" 87.613497601965534;
...
createNode transform -n "RightCam" -p "Cameras";
	...
	setAttr ".t" -type "double3" 21.552096812463031 4.9459819661723206 -1.9452978818170673e-07 ;
	setAttr -l on ".tx";
	setAttr -l on ".ty";
	setAttr -l on ".tz";
	setAttr ".r" -type "double3" 0 90 0 ;
...
createNode camera -n "RightCamShape" -p "RightCam";
	...
	setAttr ".fl" 34.999999999999979;
	setAttr ".fcp" 20000;
	setAttr ".coi" 6.8399575811778899;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
...
createNode transform -n "FrontCam" -p "Cameras";
	...
	setAttr ".t" -type "double3" 0.025734344343109061 4.9459819661723206 19.821828635447567 ;
	setAttr -l on ".tx";
	setAttr -l on ".ty";
	setAttr -l on ".tz";
	setAttr -l on ".rx";
...
createNode transform -n "QuartersCam" -p "Cameras";
	...
	setAttr ".t" -type "double3" -17.211340410398925 13.197265856920623 -12.584143565155673 ;
	setAttr -l on ".tx";
	setAttr -l on ".ty";
	setAttr -l on ".tz";
	setAttr ".r" -type "double3" -23.138352729581975 232.59999999994986 0 ;
	setAttr -l on ".rx";
	setAttr -l on ".ry";
	setAttr -l on ".rz";
...
createNode mesh -n "StandinShape" -p "Standin";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "BackYardKid" -p "Spinny_Guy";
	rename -uid "2B2F86F4-47B9-E926-1402-F69291ED50F8";
	setAttr ".t" -type "double3" 0 0.56769019365310669 0 ;
	setAttr ".r" -type "double3" 0 180 0 ;
	setAttr ".s" -type "double3" 0.10096552119918648 0.10096552119918648 0.10096552119918648 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "6587B158-48B9-EC90-8041-C3913D6F9501";
	setAttr -s 10 ".lnk";
	setAttr -s 10 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "E3C9B63A-439C-EB87-ED7F-B0B5E40E5813";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "8FE5774E-4C86-52F7-AA64-91A549ADBCCE";
createNode displayLayerManager -n "layerManager";
	rename -uid "FA393C62-4AEE-EC85-3DF3-4E9CC0F9FB97";
createNode displayLayer -n "defaultLayer";
	rename -uid "4A8DD7B2-45E5-17CB-0407-41A17C9826CB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0D5726FA-4768-F097-48E5-F4A947968C19";
...
createNode aiOptions -s -n "defaultArnoldRenderOptions";
	...
	setAttr ".ARV_options" -type "string" "Test Resolution=100%;Camera=TopCamShape;Color Management.Gamma=1;Color Management.Exposure=0;Background.BG=BG Color;Background.Color=0 0 0;Background.Image=;Background.Scale=1  1;Background.Offset=0  0;Background.Apply Color Management=1;Foreground.Enable FG=0;Foreground.Image=;Foreground.Scale=1  1;Foreground.Offset=0  0;Foreground.Apply Color Management=1;";
...
createNode reference -n "BackYardKid_ImportRN";
	rename -uid "5C22D85A-4935-AB5B-602A-5C909A4BCF66";
	setAttr ".ed" -type "dataReferenceEdits" 
		"BackYardKid_ImportRN"
		"BackYardKid_ImportRN" 0
		"BackYardKid_ImportRN" 3
		0 "|BackYardKid_Import:BackYardkidPantsGeo" "|Spinny_Guy|BackYardKid" "-s -r "
		
		0 "|BackYardKid_Import:BackYardkidShirtGeo" "|Spinny_Guy|BackYardKid" "-s -r "
		
		0 "|BackYardKid_Import:BackYardkidBodyGeo" "|Spinny_Guy|BackYardKid" "-s -r ";
...
// End of BackYardKidTurnAround.ma
