...
//Name: ChainFenceTurnAround.ma
//Last modified: Tue, Mar 03, 2026 04:33:33 PM
//Codeset: 1252
file -rdi 1 -ns "ChainFence" -rfn "ChainFenceRN" -op "v=0;" -typ "mayaAscii"
		 "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Props/ChainFence.ma";
file -r -ns "ChainFence" -dr 1 -rfn "ChainFenceRN" -op "v=0;" -typ "mayaAscii" "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Props/ChainFence.ma";
...
fileInfo "UUID" "1A9AF20A-4551-68B1-97A5-DD9973DC5F65";
createNode transform -s -n "persp";
	rename -uid "09931983-4D12-26EA-F62F-C68A0E86A1FA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 21.903684798634522 10.817187372074942 13.979842304600865 ;
	setAttr ".r" -type "double3" 346.19999999968383 -303.19999999998601 4.3564211560511789e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 20000;
	setAttr ".coi" 27.991170173426937;
...
createNode transform -n "QuartersCam" -p "Cameras";
	...
	setAttr ".t" -type "double3" -11.291865715139167 5.4630214327419395 -8.638208749431822 ;
	setAttr ".r" -type "double3" -11.138352729580738 232.1999999999486 0 ;
createNode camera -n "QuartersCamShape" -p "QuartersCam";
	rename -uid "19CD17B5-4439-CFC8-121B-42835EFB9C7E";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".fcp" 20000;
	setAttr ".coi" 15.303952471144505;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
...
createNode aiSkyDomeLight -n "aiSkyDomeLightShape1" -p "aiSkyDomeLight1";
	...
	setAttr -k off ".v";
	setAttr ".sc" -type "float3" 0.10625099 0.331 0.12746358 ;
	setAttr ".intensity" 0.20000000298023224;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "87A06982-4A8F-D334-8E98-3DBEE81178A8";
	setAttr -s 6 ".lnk";
	setAttr -s 6 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "4ECE2717-43F5-E729-1EA1-9CA98694E93C";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "439940A1-44BD-8D71-5223-499EAD8B0A85";
createNode displayLayerManager -n "layerManager";
	rename -uid "A6D3AF24-4F82-D439-BBD7-24A625E7E24F";
createNode displayLayer -n "defaultLayer";
	rename -uid "4A8DD7B2-45E5-17CB-0407-41A17C9826CB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "9C92521C-4992-C600-30FE-3799BCF9B1DB";
...
createNode reference -n "ChainFenceRN";
	rename -uid "F11AB90E-4F95-5F17-8610-EE97F5B4A3E4";
	setAttr ".ed" -type "dataReferenceEdits" 
		"ChainFenceRN"
		"ChainFenceRN" 0
		"ChainFenceRN" 7
		0 "|ChainFence:ChainFence" "|Spinny_Guy" "-s -r "
		2 "|Spinny_Guy|ChainFence:ChainFence" "translate" " -type \"double3\" 2.70195468026085761 0.69398138884205862 1.353057782721101"
		
		2 "|Spinny_Guy|ChainFence:ChainFence" "rotate" " -type \"double3\" 0 3.98095902879432773 0"
		
		2 "|Spinny_Guy|ChainFence:ChainFence" "scale" " -type \"double3\" 3.74187255223768789 3.741872552237687 3.74187255223768789"
		
		2 "|Spinny_Guy|ChainFence:ChainFence" "rotatePivot" " -type \"double3\" 2.77981877093668128 -1.8740990015342232e-09 0.24610741924111887"
		
		2 "|Spinny_Guy|ChainFence:ChainFence" "rotatePivotTranslate" " -type \"double3\" -5.06415873486411794 0 -1.84915208183211677"
		
		2 "|Spinny_Guy|ChainFence:ChainFence" "scalePivotTranslate" " -type \"double3\" 2.03692367439623023 -1.3732527898650978e-09 0.18033622692887893";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "6510155A-47B6-BAC9-2204-029A346A7459";
...
// End of ChainFenceTurnAround.ma
