...
//Name: TrashCanTurnAround.ma
//Last modified: Wed, Feb 25, 2026 05:18:49 PM
//Codeset: 1252
file -rdi 1 -ns "Trashcans" -rfn "TrashcansRN" -op "v=0;" -typ "mayaAscii" "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Props/Trashcans.ma";
file -r -ns "Trashcans" -dr 1 -rfn "TrashcansRN" -op "v=0;" -typ "mayaAscii" "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Props/Trashcans.ma";
...
fileInfo "UUID" "65BA748A-48DA-3048-CB24-BC805BFE3366";
createNode transform -s -n "persp";
	rename -uid "09931983-4D12-26EA-F62F-C68A0E86A1FA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -24.009616646656006 9.7092443823225061 -3.8666449989884955 ;
	setAttr ".r" -type "double3" 344.39999999967495 -97.599999999986807 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 20000;
	setAttr ".coi" 24.857077828966176;
...
createNode transform -n "floor";
	...
	setAttr ".s" -type "double3" 332.4796002006446 332.4796002006446 332.4796002006446 ;
...
createNode transform -n "QuartersCam" -p "Cameras";
	...
	setAttr ".t" -type "double3" -11.40053417014952 10.366761975431123 -4.7162330948885094 ;
	setAttr ".r" -type "double3" -33.338352729572286 247.39999999994012 0 ;
createNode camera -n "QuartersCamShape" -p "QuartersCam";
	rename -uid "19CD17B5-4439-CFC8-121B-42835EFB9C7E";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".fcp" 20000;
	setAttr ".coi" 15.346942556974691;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
...
createNode transform -n "aiAreaLight1";
	...
	setAttr ".t" -type "double3" -2.3074059777764444 10.456296960862076 14.654829427135686 ;
	setAttr ".r" -type "double3" 0 -377.70205248636245 0 ;
...
createNode transform -n "aiAreaLight2";
	...
	setAttr ".r" -type "double3" -2.6894812351416881 -53.108544041618359 -12.512444943611463 ;
...
createNode transform -n "aiAreaLight3";
	...
	setAttr ".r" -type "double3" -10.4205588678787 -222.26230085611928 22.464900519336197 ;
...
createNode transform -n "aiSkyDomeLight1";
	rename -uid "D4C943A4-4286-9184-4629-B09CB8AF76A9";
createNode aiSkyDomeLight -n "aiSkyDomeLightShape1" -p "aiSkyDomeLight1";
	rename -uid "C0E10707-47CE-EA98-4230-A588C83112C8";
	setAttr -k off ".v";
	setAttr ".sc" -type "float3" 0.1111538 0.32692307 0.32692307 ;
	setAttr ".intensity" 0.32051283121109009;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C5912903-4D57-FFE9-7CCC-2ABF793285E3";
	setAttr -s 20 ".lnk";
	setAttr -s 2 ".ign";
	setAttr -s 20 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "F1A1F325-45BC-E9BD-FECE-4AB26AEC8771";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "FC2A1BA8-45A7-EDAB-FE62-B2B784D67426";
createNode displayLayerManager -n "layerManager";
	rename -uid "0DD68251-479F-6B2C-F35C-E18CA3DA85C5";
createNode displayLayer -n "defaultLayer";
	rename -uid "4A8DD7B2-45E5-17CB-0407-41A17C9826CB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "35238419-4619-1C5E-3565-088A46445AB3";
...
createNode animCurveTA -n "Spinny_Guy_rotateY";
	...
	setAttr ".tan" 2;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 0 180 360;
	setAttr ".pre" 3;
	setAttr ".pst" 3;
...
createNode reference -n "TrashcansRN";
	rename -uid "3D11BD69-4E35-3997-A7FF-C0BC1BE12435";
	setAttr -s 4 ".phl";
	setAttr ".phl[1]" 0;
	setAttr ".phl[2]" 0;
	setAttr ".phl[3]" 0;
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"TrashcansRN" 0
		"TrashcansRN" 12
		0 "|Trashcans:Plastic_Can" "|Spinny_Guy" "-s -r "
		0 "|Trashcans:TwistedMeshCan" "|Spinny_Guy" "-s -r "
		0 "|Trashcans:StraightMeshCan" "|Spinny_Guy" "-s -r "
		0 "|Trashcans:CheckerboardCan" "|Spinny_Guy" "-s -r "
		2 "|Spinny_Guy|Trashcans:CheckerboardCan" "translate" " -type \"double3\" 0 0.59469019062817097 0"
		
		2 "|Spinny_Guy|Trashcans:Plastic_Can" "translate" " -type \"double3\" 0 0.59469019435346127 0"
		
		2 "|Spinny_Guy|Trashcans:StraightMeshCan" "translate" " -type \"double3\" 0 0.59469019435346127 0"
		
		2 "|Spinny_Guy|Trashcans:TwistedMeshCan" "translate" " -type \"double3\" 0 0.59469019062817097 0"
		
		5 4 "TrashcansRN" "|Spinny_Guy|Trashcans:Plastic_Can.visibility" "TrashcansRN.placeHolderList[1]" 
		""
		5 4 "TrashcansRN" "|Spinny_Guy|Trashcans:TwistedMeshCan.visibility" 
		"TrashcansRN.placeHolderList[2]" ""
		5 4 "TrashcansRN" "|Spinny_Guy|Trashcans:StraightMeshCan.visibility" 
		"TrashcansRN.placeHolderList[3]" ""
		5 4 "TrashcansRN" "|Spinny_Guy|Trashcans:CheckerboardCan.visibility" 
		"TrashcansRN.placeHolderList[4]" "";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
createNode reference -n "sharedReferenceNode";
	rename -uid "A1000A55-4A28-BF45-8456-6EBF1A9AB998";
	setAttr ".ed" -type "dataReferenceEdits" 
		"sharedReferenceNode";
createNode animCurveTU -n "TwistedMeshCan_visibility";
	rename -uid "F5CF905E-484A-122F-B5A8-A99184C46074";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  45 0 46 1 90 1 91 0;
	setAttr -s 4 ".kot[0:3]"  5 5 5 5;
createNode animCurveTU -n "CheckerboardCan_visibility";
	rename -uid "567717D8-47D8-8DF8-4059-11AB6BBAA412";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  45 0 135 0 136 1 180 1;
	setAttr -s 4 ".kot[0:3]"  5 5 5 5;
createNode animCurveTU -n "StraightMeshCan_visibility";
	rename -uid "85511F4C-4191-1397-CFF9-A58633FDF577";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  45 0 90 0 91 1 135 1 136 0;
	setAttr -s 5 ".kot[0:4]"  5 5 5 5 5;
createNode animCurveTU -n "Plastic_Can_visibility";
	rename -uid "0DADF2D0-498F-A99B-ACB4-7F870CE4FC2F";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  45 1 46 0;
	setAttr -s 2 ".kot[0:1]"  5 5;
createNode lightEditor -n "lightEditor";
	rename -uid "CA69DD9C-4D0E-358E-8E15-C09C2DE49EA2";
createNode lightItem -n "aiAreaLightShape1__LEItem";
	rename -uid "FC5017B9-4FB0-5B7D-7CAA-2AB798E607A2";
createNode lightItem -n "aiAreaLightShape2__LEItem";
	rename -uid "2F06B6DF-4EA0-0F76-95F2-B28C6C453723";
createNode lightItem -n "aiAreaLightShape3__LEItem";
	rename -uid "B2CAED36-4E8E-CFD4-7F6D-65B192955862";
createNode lightItem -n "aiSkyDomeLightShape1__LEItem";
	rename -uid "E545F2E4-4709-2C9C-D120-CDB0E9466B2E";
createNode renderSetup -n "renderSetup";
	rename -uid "FDFE3400-4CD5-BBD3-FABB-A3A17442418A";
select -ne :time1;
	setAttr ".o" 37;
	setAttr ".unw" 37;
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "Plastic_Can_visibility.o" "TrashcansRN.phl[1]";
connectAttr "TwistedMeshCan_visibility.o" "TrashcansRN.phl[2]";
connectAttr "StraightMeshCan_visibility.o" "TrashcansRN.phl[3]";
connectAttr "CheckerboardCan_visibility.o" "TrashcansRN.phl[4]";
...
connectAttr "White.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "sharedReferenceNode.sr" "TrashcansRN.sr";
...
connectAttr "aiAreaLightShape3__LEItem.nxt" "aiSkyDomeLightShape1__LEItem.prv";
