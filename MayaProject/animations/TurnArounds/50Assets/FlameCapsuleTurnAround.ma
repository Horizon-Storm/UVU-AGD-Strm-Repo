...
//Name: FlameCapsuleTurnAround.ma
//Last modified: Sat, Mar 28, 2026 03:43:11 PM
//Codeset: 1252
file -rdi 1 -ns "FlameCapsule" -rfn "FlameCapsuleRN" -op "v=0;" -typ "mayaAscii"
		 "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Sci-Fi/Props/Tools/Equipment/Backpacks/FlameCapsule.ma";
file -r -ns "FlameCapsule" -dr 1 -rfn "FlameCapsuleRN" -op "v=0;" -typ "mayaAscii"
		 "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Sci-Fi/Props/Tools/Equipment/Backpacks/FlameCapsule.ma";
...
fileInfo "UUID" "5B94FF26-4FFC-CED0-0178-5E8AE177BA10";
...
createNode transform -n "QuartersCam" -p "Cameras";
	...
	setAttr ".t" -type "double3" -13.22497242906042 5.8277434628831735 -8.4908875328369504 ;
	setAttr ".r" -type "double3" -4.5383527295804873 237.39999999994626 0 ;
createNode camera -n "QuartersCamShape" -p "QuartersCam";
	rename -uid "19CD17B5-4439-CFC8-121B-42835EFB9C7E";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".fcp" 20000;
	setAttr ".coi" 6.0019883325359222;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
...
createNode aiSkyDomeLight -n "aiSkyDomeLightShape1" -p "aiSkyDomeLight1";
	...
	setAttr -k off ".v";
	setAttr ".sc" -type "float3" 1 0.84647167 0.23699999 ;
	setAttr ".intensity" 0.20000000298023224;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C20CD9E3-4B59-6AC3-0A31-F0B7E0436B64";
	setAttr -s 13 ".lnk";
	setAttr -s 13 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "B49B3412-4CD1-5743-81C7-06A3443F74DA";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "92E2C1BA-48A7-D74E-A538-FD9260CE3FF2";
createNode displayLayerManager -n "layerManager";
	rename -uid "176AD859-4FFE-76F8-1F4F-B5A5B6DF5FAC";
createNode displayLayer -n "defaultLayer";
	rename -uid "4A8DD7B2-45E5-17CB-0407-41A17C9826CB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "AB0795B9-414A-B6D2-8396-A58EACB205AA";
...
createNode reference -n "FlameCapsuleRN";
	rename -uid "A01DB1EF-42B9-ACFA-0264-21B3DF72C1E1";
	setAttr ".ed" -type "dataReferenceEdits" 
		"FlameCapsuleRN"
		"FlameCapsuleRN" 0
		"FlameCapsuleRN" 4
		0 "|FlameCapsule:Capsule" "|Spinny_Guy" "-s -r "
		2 "|Spinny_Guy|FlameCapsule:Capsule" "translate" " -type \"double3\" -1.90005197028238815 -7.58477999870448105 -11.99798351461096146"
		
		2 "|Spinny_Guy|FlameCapsule:Capsule" "rotate" " -type \"double3\" 43.02952023450227159 39.52632234319454341 55.71438743227440682"
		
		2 "|Spinny_Guy|FlameCapsule:Capsule" "rotatePivotTranslate" " -type \"double3\" 1.90005197028241479 -4.37231404135239377 11.99798351461100232";
...
// End of FlameCapsuleTurnAround.ma
