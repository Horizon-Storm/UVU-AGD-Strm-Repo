...
//Last modified: Wed, Mar 04, 2026 08:38:56 PM
//Codeset: 1252
...
fileInfo "UUID" "90F3CF06-4ADA-84D7-56DE-36A8C7FFEEB2";
createNode transform -s -n "persp";
	rename -uid "09931983-4D12-26EA-F62F-C68A0E86A1FA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 9.0069471043614122 10.202503744517447 22.99123506109725 ;
	setAttr ".r" -type "double3" 346.79999999967959 -337.59999999997706 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 20000;
	setAttr ".coi" 26.547509859053321;
...
createNode transform -n "QuartersCam" -p "Cameras";
	...
	setAttr ".t" -type "double3" -13.399548358547849 9.4179686237256455 -10.085922533482941 ;
...
createNode camera -n "QuartersCamShape" -p "QuartersCam";
	...
	setAttr ".fcp" 20000;
	setAttr ".coi" 18.572590414981974;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "E8E6F4D8-4D61-6811-52CF-49BD8EF2837F";
	setAttr -s 20 ".lnk";
	setAttr -s 20 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "9089A4DE-4E49-98A1-3191-BAB99189B6A5";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "FF009EF7-456B-82B4-3C7A-649962A427B2";
createNode displayLayerManager -n "layerManager";
	rename -uid "FA6A2117-4108-3424-9A53-788A7B391244";
createNode displayLayer -n "defaultLayer";
	rename -uid "4A8DD7B2-45E5-17CB-0407-41A17C9826CB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "138409D9-4D1F-5A94-6999-F3AD3C076EE6";
