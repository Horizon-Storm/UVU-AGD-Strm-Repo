...
//Name: NestChargerTurnAround.ma
//Last modified: Fri, Mar 27, 2026 03:19:58 PM
//Codeset: 1252
file -rdi 1 -ns "LoaderNestCharger" -rfn "LoaderNestChargerRN" -op "v=0;" -typ
		 "mayaAscii" "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Sci-Fi/Props/Tech/Chargers/LoaderNestCharger.ma";
file -r -ns "LoaderNestCharger" -dr 1 -rfn "LoaderNestChargerRN" -op "v=0;" -typ
		 "mayaAscii" "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Sci-Fi/Props/Tech/Chargers/LoaderNestCharger.ma";
...
fileInfo "UUID" "2F496C19-4CE8-4170-6EB9-F7851BEC9677";
createNode transform -s -n "persp";
	rename -uid "09931983-4D12-26EA-F62F-C68A0E86A1FA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -10.89919022591093 26.501296967107628 -8.0373187108715989 ;
	setAttr ".r" -type "double3" 298.19999999983418 -488.79999999993191 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 20000;
	setAttr ".coi" 28.535168843068398;
...
createNode transform -n "QuartersCam" -p "Cameras";
	...
	setAttr ".t" -type "double3" -10.625578529080716 4.018309507161069 -7.3157128256702508 ;
...
createNode camera -n "QuartersCamShape" -p "QuartersCam";
	...
	setAttr ".fcp" 20000;
	setAttr ".coi" 3.2925916909345849;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
...
createNode aiSkyDomeLight -n "aiSkyDomeLightShape1" -p "aiSkyDomeLight1";
	...
	setAttr -k off ".v";
	setAttr ".sc" -type "float3" 0.70499998 1 0.89999998 ;
	setAttr ".intensity" 0.10000000149011612;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "771662D3-4CFB-1432-0942-88838FC25948";
	setAttr -s 11 ".lnk";
	setAttr -s 11 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "3134734D-49D2-7E51-9065-2FAF2E2A990C";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "CAA9E9F5-4F14-231B-8083-678FFEFF06FB";
createNode displayLayerManager -n "layerManager";
	rename -uid "B4EE7B15-474C-9073-F5EC-68A5AEEAC425";
createNode displayLayer -n "defaultLayer";
	rename -uid "4A8DD7B2-45E5-17CB-0407-41A17C9826CB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "06D62BEF-4DF0-8CF9-9BEF-749D66076D79";
...
createNode animCurveTU -n "FloorGrate2_visibility";
	...
	setAttr -s 4 ".kot[0:3]"  5 5 5 5;
createNode reference -n "LoaderNestChargerRN";
	rename -uid "E8CBD1C6-4E69-952C-3C11-2FA8E738CCF7";
	setAttr ".ed" -type "dataReferenceEdits" 
		"LoaderNestChargerRN"
		"LoaderNestChargerRN" 0
		"LoaderNestChargerRN" 7
		0 "|LoaderNestCharger:NestCharger" "|Spinny_Guy" "-s -r "
		2 "|Spinny_Guy|LoaderNestCharger:NestCharger" "translate" " -type \"double3\" 0.99880134471346826 1.28731498529369581 -0.5614862739067259"
		
		2 "|Spinny_Guy|LoaderNestCharger:NestCharger" "rotate" " -type \"double3\" 0.64916596383577374 -18.85014993204331901 32.95582913549417725"
		
		2 "|Spinny_Guy|LoaderNestCharger:NestCharger" "scale" " -type \"double3\" 5.4408040900312189 5.44080409003121801 5.4408040900312189"
		
		2 "|Spinny_Guy|LoaderNestCharger:NestCharger" "rotatePivot" " -type \"double3\" -6.4859439015760647e-07 2.09419532930309549 -9.7289158523640976e-07"
		
		2 "|Spinny_Guy|LoaderNestCharger:NestCharger" "rotatePivotTranslate" " -type \"double3\" -0.99880069611908073 -0.34125975852784407 0.56148724679831075"
		
		2 "|Spinny_Guy|LoaderNestCharger:NestCharger" "scalePivotTranslate" " -type \"double3\" -5.2938510060682522e-07 1.70928984572942033 -7.9407765091023788e-07";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "035F3644-441B-2AE8-D4A6-7290E70DDE53";
...
// End of NestChargerTurnAround.ma
