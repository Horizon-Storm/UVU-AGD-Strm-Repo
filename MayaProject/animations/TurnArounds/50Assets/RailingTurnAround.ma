...
//Name: RailingTurnAround.ma
//Last modified: Fri, Feb 27, 2026 07:58:14 PM
//Codeset: 1252
file -rdi 1 -ns "vWireRailing" -rfn "vWireRailingRN" -op "v=0;" -typ "mayaAscii"
		 "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Sci-Fi/Props/Railing/vWireRailing.ma";
file -r -ns "vWireRailing" -dr 1 -rfn "vWireRailingRN" -op "v=0;" -typ "mayaAscii"
		 "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Sci-Fi/Props/Railing/vWireRailing.ma";
...
fileInfo "UUID" "E320CFFD-4AA2-522D-2BA1-5AA0FD68305F";
...
createNode transform -n "QuartersCam" -p "Cameras";
	...
	setAttr ".t" -type "double3" -10.931772252775241 5.8099101021490176 -8.4779421249115572 ;
...
createNode camera -n "QuartersCamShape" -p "QuartersCam";
	...
	setAttr ".fcp" 20000;
	setAttr ".coi" 14.995415599755907;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
...
createNode aiSkyDomeLight -n "aiSkyDomeLightShape1" -p "aiSkyDomeLight1";
	...
	setAttr -k off ".v";
	setAttr ".sc" -type "float3" 0.47435898 0.34134117 0.15226914 ;
	setAttr ".intensity" 0.20000000298023224;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "B759387F-4B76-7044-E149-B892D0795681";
	setAttr -s 5 ".lnk";
	setAttr -s 5 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "E9364E54-4719-4189-326D-6D898737A87E";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "079BF8DF-4A60-97F2-48A9-83B9AA28F061";
createNode displayLayerManager -n "layerManager";
	rename -uid "715ED35D-497E-F797-E67B-D5B114AEC5F1";
createNode displayLayer -n "defaultLayer";
	rename -uid "4A8DD7B2-45E5-17CB-0407-41A17C9826CB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "C2A55C28-4733-09C2-50C4-2EAE30B61790";
...
createNode reference -n "vWireRailingRN";
	rename -uid "B253E406-4148-A702-59BF-659CBD463876";
	setAttr ".ed" -type "dataReferenceEdits" 
		"vWireRailingRN"
		"vWireRailingRN" 0
		"vWireRailingRN" 3
		0 "|vWireRailing:RailingwWire" "|Spinny_Guy" "-s -r "
		2 "|Spinny_Guy|vWireRailing:RailingwWire" "translate" " -type \"double3\" 0 0.56769019365310669 0"
		
		2 "|Spinny_Guy|vWireRailing:RailingwWire" "scale" " -type \"double3\" 1.36146567149898079 1.36146567149898079 1.36146567149898079";
