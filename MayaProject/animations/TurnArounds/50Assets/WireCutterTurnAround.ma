...
//Name: WireCutterTurnAround.ma
//Last modified: Tue, Mar 17, 2026 10:42:49 PM
//Codeset: 1252
file -rdi 1 -ns "Wirecutters" -rfn "WirecuttersRN" -op "v=0;" -typ "mayaAscii"
		 "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Sci-Fi/Props/Tools/Wirecutters.ma";
file -r -ns "Wirecutters" -dr 1 -rfn "WirecuttersRN" -op "v=0;" -typ "mayaAscii"
		 "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Sci-Fi/Props/Tools/Wirecutters.ma";
...
fileInfo "UUID" "0628D4AA-40DB-B89E-3A37-7998E7B72323";
...
createNode transform -n "QuartersCam" -p "Cameras";
	...
	setAttr ".t" -type "double3" -12.758148271272269 4.3779218031314535 -9.0566038473340811 ;
...
createNode camera -n "QuartersCamShape" -p "QuartersCam";
	...
	setAttr ".fcp" 20000;
	setAttr ".coi" 16.672383823435496;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "2F50B5C5-4713-E9BD-0809-3C93CFE45534";
	setAttr -s 5 ".lnk";
	setAttr -s 5 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "49A70A49-4A5A-1EE7-9626-7AA10C6F05C7";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "563C75FD-4A5D-64DD-9F2D-FB9DA881502D";
createNode displayLayerManager -n "layerManager";
	rename -uid "E498DF72-42BA-E246-70BC-54AE8611B0A4";
createNode displayLayer -n "defaultLayer";
	rename -uid "4A8DD7B2-45E5-17CB-0407-41A17C9826CB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "14319579-4DC1-01E4-A95E-3A8A5F3952C0";
...
createNode reference -n "WirecuttersRN";
	rename -uid "4249DC3E-496B-CCB2-29F4-269DFE89E2B0";
	setAttr ".ed" -type "dataReferenceEdits" 
		"WirecuttersRN"
		"WirecuttersRN" 0
		"WirecuttersRN" 4
		0 "|Wirecutters:Plyers" "|Spinny_Guy" "-s -r "
		2 "|Spinny_Guy|Wirecutters:Plyers" "translate" " -type \"double3\" -0.32376277639316026 7.41102547514144661 -0.014135788096003127"
		
		2 "|Spinny_Guy|Wirecutters:Plyers" "rotate" " -type \"double3\" -28.30661128596711507 -2.5 0"
		
		2 "|Spinny_Guy|Wirecutters:Plyers" "scale" " -type \"double3\" 0.68623502885948684 0.68623502885948695 0.68623502885948684";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "99DAE135-4F8A-D0E8-9F2D-959FFF1A41AD";
...
// End of WireCutterTurnAround.ma
