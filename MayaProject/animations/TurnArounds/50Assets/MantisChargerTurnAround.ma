...
//Name: MantisChargerTurnAround.ma
//Last modified: Wed, Mar 18, 2026 10:49:02 PM
//Codeset: 1252
file -rdi 1 -ns "MantisBotCharger" -rfn "MantisBotChargerRN" -op "v=0;" -typ
		 "mayaAscii" "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Sci-Fi/Props/Tech/Chargers/MantisBotCharger.ma";
file -r -ns "MantisBotCharger" -dr 1 -rfn "MantisBotChargerRN" -op "v=0;" -typ "mayaAscii"
		 "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Sci-Fi/Props/Tech/Chargers/MantisBotCharger.ma";
...
fileInfo "UUID" "29A794D4-4839-D4A0-0661-768A36224112";
createNode transform -s -n "persp";
	rename -uid "09931983-4D12-26EA-F62F-C68A0E86A1FA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 12.036572862099403 3.9889251787509932 17.159292029083662 ;
	setAttr ".r" -type "double3" 363.59999999967459 -325.19999999997287 2.4208105589147326e-16 ;
...
createNode camera -n "QuartersCamShape" -p "QuartersCam";
	...
	setAttr ".fcp" 20000;
	setAttr ".coi" 3.9398244263081423;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -1.9136496747229614e-06 0.2838450907588671 1.7853058498218388e-06 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
...
createNode mesh -n "StandinShape" -p "Standin";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "MantisCharger" -p "Spinny_Guy";
	rename -uid "D37FD764-4912-B7C1-11F3-CAB4BF3CF504";
	setAttr ".t" -type "double3" 0 0.56769019365310669 0 ;
...
createNode aiSkyDomeLight -n "aiSkyDomeLightShape1" -p "aiSkyDomeLight1";
	...
	setAttr -k off ".v";
	setAttr ".sc" -type "float3" 0.2753 0.2245 0.461 ;
	setAttr ".intensity" 0.10000000149011612;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "2FF5E267-49BF-7ED1-D48C-EC8DF90BDAD8";
	setAttr -s 10 ".lnk";
	setAttr -s 10 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "3CC4F288-453A-6C22-C2C3-CDB3C71BF46F";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "44AF0200-4E19-E43A-F819-D99F8CB4B17C";
createNode displayLayerManager -n "layerManager";
	rename -uid "5FF1E528-41F0-6ED9-DB04-82914C1C55A8";
createNode displayLayer -n "defaultLayer";
	rename -uid "4A8DD7B2-45E5-17CB-0407-41A17C9826CB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "2D8536AC-420C-9F27-FE3A-A4963759C8A0";
...
createNode reference -n "MantisBotChargerRN";
	rename -uid "9A95A3EC-4835-7F13-3932-888EDD05C6E9";
	setAttr -s 4 ".phl";
	setAttr ".phl[1]" 0;
	setAttr ".phl[2]" 0;
	setAttr ".phl[3]" 0;
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		"MantisBotChargerRN"
		"MantisBotChargerRN" 0
		"MantisBotChargerRN" 9
		0 "|MantisBotCharger:PinsGeo" "|Spinny_Guy|MantisCharger" "-s -r "
		0 "|MantisBotCharger:ChargerGeoLow" "|Spinny_Guy|MantisCharger" "-s -r "
		2 "|Spinny_Guy|MantisCharger|MantisBotCharger:ChargerGeoLow|MantisBotCharger:ChargerGeoLowShape" 
		"uvPivot" " -type \"double2\" 0.47585346578853205 0.49999996274709702"
		2 "|Spinny_Guy|MantisCharger|MantisBotCharger:ChargerGeoLow|MantisBotCharger:ChargerGeoLowShape" 
		"uvSet[0].uvSetName" " -type \"string\" \"map1\""
		3 "MantisBotCharger:polyNormal1.output" "|Spinny_Guy|MantisCharger|MantisBotCharger:ChargerGeoLow|MantisBotCharger:ChargerGeoLowShape.inMesh" 
		""
		5 4 "MantisBotChargerRN" "|Spinny_Guy|MantisCharger|MantisBotCharger:ChargerGeoLow|MantisBotCharger:ChargerGeoLowShape.inMesh" 
		"MantisBotChargerRN.placeHolderList[1]" ""
		5 3 "MantisBotChargerRN" "|Spinny_Guy|MantisCharger|MantisBotCharger:ChargerGeoLow|MantisBotCharger:ChargerGeoLowShape.worldMatrix" 
		"MantisBotChargerRN.placeHolderList[2]" ""
		5 3 "MantisBotChargerRN" "|Spinny_Guy|MantisCharger|MantisBotCharger:ChargerGeoLow|MantisBotCharger:ChargerGeoLowShape.worldMatrix" 
		"MantisBotChargerRN.placeHolderList[3]" ""
		5 3 "MantisBotChargerRN" "MantisBotCharger:polyNormal1.output" "MantisBotChargerRN.placeHolderList[4]" 
		"MantisBotCharger:ChargerGeoLowShape.i";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
createNode animCurveTL -n "QuartersCam_translateX";
	rename -uid "66B1538B-4C91-FDC0-FA80-3DA440249C5B";
	setAttr ".tan" 28;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 -7.8118132227247647 100 -7.8118132227247647
		 190 -2.9561299553030471 208 -1.5396035282716678 240 -1.214903954011715 288 -7.8118132227247647;
	setAttr -s 6 ".kit[0:5]"  2 28 28 28 28 2;
	setAttr -s 6 ".kot[0:5]"  2 18 18 18 18 2;
createNode animCurveTL -n "QuartersCam_translateY";
	rename -uid "8D43E129-4295-1064-C26E-B38C36F9F66F";
	setAttr ".tan" 28;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 2.9620979546812576 100 2.9620979546812576
		 190 5.4546623254476332 208 5.2621725024052282 240 3.7218071830480999 288 2.9620979546812576;
	setAttr -s 6 ".kit[0:5]"  2 28 28 28 28 2;
	setAttr -s 6 ".kot[0:5]"  2 18 18 18 18 2;
createNode animCurveTL -n "QuartersCam_translateZ";
	rename -uid "1CD5F82B-4EC3-6F5C-9239-1499DF7A719D";
	setAttr ".tan" 28;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 -7.0468552953130059 100 -7.0468552953130059
		 190 1.0682693391414317 208 0.43667065585831638 240 -1.8770997578871622 288 -7.0468552953130059;
	setAttr -s 6 ".kit[0:5]"  2 28 28 28 28 2;
	setAttr -s 6 ".kot[0:5]"  2 18 18 18 18 2;
createNode animCurveTU -n "QuartersCam_visibility";
	rename -uid "2D601486-4325-D7FD-F4E6-4AB5DF2AD0FB";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 1 100 1 190 1 208 1 240 1 288 1;
	setAttr -s 6 ".kit[0:5]"  2 9 9 9 9 2;
	setAttr -s 6 ".kot[0:5]"  2 5 5 5 5 2;
createNode animCurveTA -n "QuartersCam_rotateX";
	rename -uid "4329AB8B-4494-3065-E5DD-38BEFBC823D0";
	setAttr ".tan" 28;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 1.461647270419038 100 1.461647270419038
		 190 -54.338352729579888 208 -60.198872699361942 240 -62.368037639764438 288 1.461647270419038;
	setAttr -s 6 ".kit[0:5]"  2 28 28 28 28 2;
	setAttr -s 6 ".kot[0:5]"  2 18 18 18 18 2;
createNode animCurveTA -n "QuartersCam_rotateY";
	rename -uid "B4C372AF-4274-1FAF-EAD3-B68339A8C35E";
	setAttr ".tan" 28;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 227.39999999994691 100 227.39999999994691
		 190 282.19999999994405 208 254.61869814145751 240 188.85847053517179 288 227.39999999994691;
	setAttr -s 6 ".kit[0:5]"  2 28 28 28 28 2;
	setAttr -s 6 ".kot[0:5]"  2 18 18 18 18 2;
createNode animCurveTU -n "QuartersCam_scaleX";
	rename -uid "8C3DF125-48A0-8E14-12A6-938595DE8930";
	setAttr ".tan" 28;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 1 100 1 190 1 208 1 240 1 288 1;
	setAttr -s 6 ".kit[0:5]"  2 28 28 28 28 2;
...
createNode animCurveTU -n "QuartersCam_scaleY";
	rename -uid "2BCBC565-4D04-B087-02CF-A28898C46AE6";
	setAttr ".tan" 28;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 1 100 1 190 1 208 1 240 1 288 1;
	setAttr -s 6 ".kit[0:5]"  2 28 28 28 28 2;
...
createNode animCurveTU -n "QuartersCam_scaleZ";
	rename -uid "AFA15F48-40DE-0F04-8A95-1FAC282DC3D1";
	setAttr ".tan" 28;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 1 100 1 190 1 208 1 240 1 288 1;
	setAttr -s 6 ".kit[0:5]"  2 28 28 28 28 2;
...
createNode polySoftEdge -n "polySoftEdge1";
	rename -uid "A3AD864E-4E2E-0619-BCAD-37B6D21AA2A8";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 8 "e[2396]" "e[2402]" "e[2405]" "e[2410]" "e[2413]" "e[2416]" "e[2419]" "e[2422]";
	setAttr ".ix" -type "matrix" -0.99619469809174532 0 -0.08715574274765818 0 0 1 0 0
		 0.08715574274765818 0 -0.99619469809174532 0 0 0.56769019365310669 0 1;
	setAttr ".a" 180;
createNode polySoftEdge -n "polySoftEdge2";
	rename -uid "E63AB004-408B-991A-53F5-23B2FEB8E2B8";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 1 "e[*]";
	setAttr ".ix" -type "matrix" -0.99619469809174532 0 -0.08715574274765818 0 0 1 0 0
		 0.08715574274765818 0 -0.99619469809174532 0 0 0.56769019365310669 0 1;
createNode animCurveTA -n "QuartersCam_rotateZ";
	rename -uid "FA05EA28-42D1-1622-3539-30BD2B248C15";
	setAttr ".tan" 28;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 0 100 0 190 -1.5050551259607183e-14 208 -1.0603293969008383e-14
		 240 0 288 0;
	setAttr -s 6 ".kot[0:5]"  18 18 18 18 18 18;
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "3752269D-401F-253E-5E8F-60998EAAD4BD";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -374.64393443583606 -754.17318977846435 ;
	setAttr ".tgi[0].vh" -type "double2" 900.10044479241833 345.83987267083916 ;
...
select -ne :hardwareRenderGlobals;
	setAttr ".ctrs" 256;
	setAttr ".btrs" 512;
connectAttr "polySoftEdge2.out" "MantisBotChargerRN.phl[1]";
connectAttr "MantisBotChargerRN.phl[2]" "polySoftEdge1.mp";
connectAttr "MantisBotChargerRN.phl[3]" "polySoftEdge2.mp";
connectAttr "MantisBotChargerRN.phl[4]" "polySoftEdge1.ip";
...
// End of MantisChargerTurnAround.ma
