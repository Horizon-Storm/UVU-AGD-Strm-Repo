...
//Name: PenScrewDriverTurnAround.ma
//Last modified: Wed, Mar 25, 2026 12:22:55 AM
//Codeset: 1252
file -rdi 1 -ns "PenScrewDriver" -rfn "PenScrewDriverRN" -op "v=0;" -typ "mayaAscii"
		 "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Sci-Fi/Props/Tools/PenScrewDriver.ma";
file -r -ns "PenScrewDriver" -dr 1 -rfn "PenScrewDriverRN" -op "v=0;" -typ "mayaAscii"
		 "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Sci-Fi/Props/Tools/PenScrewDriver.ma";
...
fileInfo "UUID" "7F1C5419-468D-C45E-3BB9-A880F9687112";
createNode transform -s -n "persp";
	rename -uid "09931983-4D12-26EA-F62F-C68A0E86A1FA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -15.279422722820522 15.995244750561939 32.124371558528196 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 20000;
	setAttr ".coi" 37.886559350309554;
...
createNode transform -n "QuartersCam" -p "Cameras";
	...
	setAttr ".t" -type "double3" -12.074766821034261 4.9590881793835768 -8.5709499293517375 ;
...
createNode aiSkyDomeLight -n "aiSkyDomeLightShape1" -p "aiSkyDomeLight1";
	...
	setAttr -k off ".v";
	setAttr ".sc" -type "float3" 0.78399998 0.36220801 0.69524086 ;
	setAttr ".intensity" 0.10000000149011612;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "E8037793-4BA4-5D30-7DDC-CCB8E18903A3";
	setAttr -s 7 ".lnk";
	setAttr -s 7 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "0E3582AE-4E85-C88B-6880-39998451A3B4";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "21E21E41-47E5-C36C-950E-C19D8C00BF3E";
createNode displayLayerManager -n "layerManager";
	rename -uid "398C04CE-4A7C-B871-A169-F1A587BDAC47";
createNode displayLayer -n "defaultLayer";
	rename -uid "4A8DD7B2-45E5-17CB-0407-41A17C9826CB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "6D1015D4-4511-CE6E-17EA-55825F794BF7";
...
createNode nodeGraphEditorInfo -n "MayaNodeEditorSavedTabsInfo";
	rename -uid "73FEFCB2-4902-BF5A-862F-CAADB2B023D5";
	setAttr ".pee" yes;
...
createNode reference -n "PenScrewDriverRN";
	rename -uid "C5C7ABCF-429E-2D67-5928-70AA7316D2EA";
	setAttr -s 6 ".phl";
	setAttr ".phl[1]" 0;
	setAttr ".phl[2]" 0;
	setAttr ".phl[3]" 0;
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"PenScrewDriverRN" 0
		"PenScrewDriverRN" 12
		0 "|PenScrewDriver:PenScrewDriver" "|Spinny_Guy" "-s -r "
		2 "|Spinny_Guy|PenScrewDriver:PenScrewDriver" "translate" " -type \"double3\" 0 -3.75247985597411482 0"
		
		2 "|Spinny_Guy|PenScrewDriver:PenScrewDriver" "rotate" " -type \"double3\" 190.12749651233420423 -20.70343569186530175 153.57304776140435365"
		
		2 "|Spinny_Guy|PenScrewDriver:PenScrewDriver" "scale" " -type \"double3\" 0.78756123152260327 0.78756123152260327 0.78756123152260327"
		
		2 "|Spinny_Guy|PenScrewDriver:PenScrewDriver" "rotatePivotTranslate" " -type \"double3\" 0 0 0"
		
		2 "PenScrewDriver:displacementShader1" "scale" " 0"
		5 4 "PenScrewDriverRN" "PenScrewDriver:LightMAt.emissionColorR" "PenScrewDriverRN.placeHolderList[1]" 
		""
		5 4 "PenScrewDriverRN" "PenScrewDriver:LightMAt.emissionColorG" "PenScrewDriverRN.placeHolderList[2]" 
		""
		5 4 "PenScrewDriverRN" "PenScrewDriver:LightMAt.emissionColorB" "PenScrewDriverRN.placeHolderList[3]" 
		""
		5 4 "PenScrewDriverRN" "PenScrewDriver:LightMAt.baseColorR" "PenScrewDriverRN.placeHolderList[4]" 
		""
		5 4 "PenScrewDriverRN" "PenScrewDriver:LightMAt.baseColorG" "PenScrewDriverRN.placeHolderList[5]" 
		""
		5 4 "PenScrewDriverRN" "PenScrewDriver:LightMAt.baseColorB" "PenScrewDriverRN.placeHolderList[6]" 
		"";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
createNode animCurveTU -n "LightMAt_emissionColorR";
	rename -uid "5A28B9E2-4D05-39DE-E19D-C68537E2A99E";
	setAttr ".tan" 28;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 1 45 1 75 1 115 0.47870001196861267 144 1;
	setAttr -s 5 ".kot[0:4]"  18 18 18 18 18;
createNode animCurveTU -n "LightMAt_emissionColorG";
	rename -uid "562D12C8-4473-5D8C-9774-ACBEB1FD1009";
	setAttr ".tan" 28;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 1 45 0 75 0.44269999861717224 115 0.87199997901916504
		 144 1;
	setAttr -s 5 ".kot[0:4]"  18 18 18 18 18;
createNode animCurveTU -n "LightMAt_emissionColorB";
	rename -uid "5A539840-41C7-9FD7-6588-CA8ECF34E682";
	setAttr ".tan" 28;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 1 45 0 75 0 115 0.47870001196861267 144 1;
	setAttr -s 5 ".kot[0:4]"  18 18 18 18 18;
createNode animCurveTU -n "LightMAt_baseColorR";
	rename -uid "98C2C9DE-4DC3-CD32-17A0-45863B759BE0";
	setAttr ".tan" 28;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 1 45 0.93379998207092285 75 1 115 0 144 1;
	setAttr -s 5 ".kot[0:4]"  18 18 18 18 18;
createNode animCurveTU -n "LightMAt_baseColorG";
	rename -uid "9B7ED400-4A30-04AC-951A-6EA3C535A72D";
	setAttr ".tan" 28;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 1 45 0.27459999918937683 75 0.49810001254081726
		 115 1 144 1;
	setAttr -s 5 ".kot[0:4]"  18 18 18 18 18;
createNode animCurveTU -n "LightMAt_baseColorB";
	rename -uid "AD8BC5EF-4FB3-0DC7-7EC7-3F9D65CD9A26";
	setAttr ".tan" 28;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 1 45 0.27459999918937683 75 0.058699999004602432
		 115 0 144 1;
	setAttr -s 5 ".kot[0:4]"  18 18 18 18 18;
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "33E641A8-4FE1-3B32-A9EC-96B61C30BB1C";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -319.4601901594973 -671.42854474839828 ;
	setAttr ".tgi[0].vh" -type "double2" 763.50779156225008 263.09522764077315 ;
...
select -ne :hardwareRenderGlobals;
	setAttr ".ctrs" 256;
	setAttr ".btrs" 512;
connectAttr "LightMAt_emissionColorR.o" "PenScrewDriverRN.phl[1]";
connectAttr "LightMAt_emissionColorG.o" "PenScrewDriverRN.phl[2]";
connectAttr "LightMAt_emissionColorB.o" "PenScrewDriverRN.phl[3]";
connectAttr "LightMAt_baseColorR.o" "PenScrewDriverRN.phl[4]";
connectAttr "LightMAt_baseColorG.o" "PenScrewDriverRN.phl[5]";
connectAttr "LightMAt_baseColorB.o" "PenScrewDriverRN.phl[6]";
...
connectAttr "Spinny_Guy_scaleX.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[0].dn"
		;
connectAttr "Spinny_Guy_translateY.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[1].dn"
		;
connectAttr "Spinny_Guy_scaleY.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
connectAttr "Spinny_Guy_translateZ.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "Spinny_Guy_translateX.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
connectAttr "Spinny_Guy_scaleZ.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
connectAttr "Spinny_Guy_visibility.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[6].dn"
		;
...
// End of PenScrewDriverTurnAround.ma
