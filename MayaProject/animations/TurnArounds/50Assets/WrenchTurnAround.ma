...
//Name: WrenchTurnAround.ma
//Last modified: Fri, Mar 06, 2026 12:17:35 AM
//Codeset: 1252
file -rdi 1 -ns "PipeWrench" -rfn "PipeWrenchRN" -op "v=0;" -typ "mayaAscii"
		 "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Sci-Fi/Props/Tools/PipeWrench.ma";
file -r -ns "PipeWrench" -dr 1 -rfn "PipeWrenchRN" -op "v=0;" -typ "mayaAscii" "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Sci-Fi/Props/Tools/PipeWrench.ma";
...
fileInfo "UUID" "306E21DB-4C7E-85F5-D867-CC91D4C59057";
createNode transform -s -n "persp";
	rename -uid "09931983-4D12-26EA-F62F-C68A0E86A1FA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -23.761293154270785 7.7090497408095011 8.2522952670555281 ;
	setAttr ".r" -type "double3" 347.99999999955651 -424.39999999998241 3.6804670025336494e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 20000;
	setAttr ".coi" 26.341364791830948;
...
createNode transform -n "QuartersCam" -p "Cameras";
	...
	setAttr ".t" -type "double3" -3.8283722472076609 5.6289155479669342 -13.906751140930533 ;
	setAttr ".r" -type "double3" -7.5383527295799446 195.39999999994834 0 ;
createNode camera -n "QuartersCamShape" -p "QuartersCam";
	rename -uid "19CD17B5-4439-CFC8-121B-42835EFB9C7E";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".fcp" 20000;
	setAttr ".coi" 17.711846667321442;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
...
createNode aiAreaLight -n "aiAreaLightShape3" -p "aiAreaLight3";
	...
	setAttr ".ai_translator" -type "string" "quad";
	setAttr ".aal" -type "attributeAlias" 4 "exposure" "aiExposure" "normalize" "aiNormalize" ;
createNode fosterParent -n "ScrewDriverRNfosterParent1";
	rename -uid "C1C56EDF-4405-9FA0-4C20-79BFFC460336";
createNode transform -n "light_ScrewDriver:Glow_MeshLight" -p "ScrewDriverRNfosterParent1";
	rename -uid "E9E022CF-402F-C796-F76A-4A84A1191C08";
	setAttr ".rp" -type "double3" -1.7186412812629005e-15 0.50934405590955967 -3.6630787240529159 ;
	setAttr ".sp" -type "double3" -1.7186412812629005e-15 0.50934405590955967 -3.6630787240529159 ;
createNode aiMeshLight -n "light_ScrewDriver:Glow_MeshLightShape" -p "light_ScrewDriver:Glow_MeshLight";
	rename -uid "045BC908-41A9-1477-824C-3CA4F33F6093";
	setAttr -k off ".v";
	setAttr ".csh" no;
	setAttr ".rcsh" no;
	setAttr ".lp" -type "double3" -1.7186412812629005e-15 0.50934405590955967 -3.6630787240529159 ;
	setAttr ".ai_exposure" 5;
createNode transform -n "aiSkyDomeLight1";
	rename -uid "A5CBAB38-49DA-E23B-B4C8-7DAFD40E3DBD";
createNode aiSkyDomeLight -n "aiSkyDomeLightShape1" -p "aiSkyDomeLight1";
	rename -uid "EFFF420D-42AF-750A-638F-0D9CED6DF6B1";
	setAttr -k off ".v";
	setAttr ".ai_exposure" -4.2207794189453125;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "1FEFFB60-4D66-174B-E808-D6A99ED7DF31";
	setAttr -s 11 ".lnk";
	setAttr -s 11 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "DD41FD56-4FFE-AE74-BEB1-029D923E5444";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "CDEBCC22-4883-8813-0E09-8A8D5D18837B";
createNode displayLayerManager -n "layerManager";
	rename -uid "84BFA3F8-49FB-F16F-A659-74A53874676A";
createNode displayLayer -n "defaultLayer";
	rename -uid "4A8DD7B2-45E5-17CB-0407-41A17C9826CB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "1C07484C-4179-CB5C-7452-CC8A721DC5A5";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "166FF96D-4EAA-5D30-A2FE-BC9266357435";
...
createNode reference -n "PipeWrenchRN";
	rename -uid "EF18ACA6-49F4-23EA-6A0A-75A1D3D60794";
	setAttr ".ed" -type "dataReferenceEdits" 
		"PipeWrenchRN"
		"PipeWrenchRN" 0
		"PipeWrenchRN" 8
		0 "|PipeWrench:Wrench" "|Spinny_Guy" "-s -r "
		2 "|Spinny_Guy|PipeWrench:Wrench" "translate" " -type \"double3\" 0.2168658101768301 8.44697791410945698 2.89478162662520555"
		
		2 "|Spinny_Guy|PipeWrench:Wrench" "rotate" " -type \"double3\" 30.79698416885094048 -2.91015059076040794 -20.26950457619364698"
		
		2 "|Spinny_Guy|PipeWrench:Wrench" "scale" " -type \"double3\" 0.87160855982187035 0.87160855982187035 0.87160855982187035"
		
		2 "|Spinny_Guy|PipeWrench:Wrench" "rotatePivot" " -type \"double3\" 0 -2.64822291180586555 0"
		
		2 "|Spinny_Guy|PipeWrench:Wrench" "rotatePivotTranslate" " -type \"double3\" -0.78268358467377463 1.92042432397884499 -2.42297342380240277"
		
		2 "|Spinny_Guy|PipeWrench:Wrench" "scalePivot" " -type \"double3\" 0 -3.03831677874650463 0"
		
		2 "|Spinny_Guy|PipeWrench:Wrench" "scalePivotTranslate" " -type \"double3\" 0 0.3900938669406438 0";
...
connectAttr "lambert2SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[1].dn"
		;
connectAttr "light_ScrewDriver:Glow_MeshLightShape.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
...
connectAttr "light_ScrewDriver:Glow_MeshLightShape.ltd" ":lightList1.l" -na;
connectAttr "aiSkyDomeLightShape1.ltd" ":lightList1.l" -na;
connectAttr "aiAreaLight1.iog" ":defaultLightSet.dsm" -na;
connectAttr "aiAreaLight2.iog" ":defaultLightSet.dsm" -na;
connectAttr "aiAreaLight3.iog" ":defaultLightSet.dsm" -na;
connectAttr "aiSkyDomeLight1.iog" ":defaultLightSet.dsm" -na;
// End of WrenchTurnAround.ma
