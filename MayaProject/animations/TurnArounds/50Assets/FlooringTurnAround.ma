...
file -r -ns "GratePaneling" -dr 1 -rfn "GratePanelingRN" -op "v=0;" -typ "mayaAscii"
		 "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Sci-Fi/Props/BuildingComponents/GratePaneling.ma";
...
createNode transform -n "QuartersCam" -p "Cameras";
	...
	setAttr ".t" -type "double3" -12.308449972358622 4.9306672269215408 -8.7370199009139036 ;
...
createNode camera -n "QuartersCamShape" -p "QuartersCam";
	...
	setAttr ".fcp" 20000;
	setAttr ".coi" 5.3869679543425093;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
...
createNode aiSkyDomeLight -n "aiSkyDomeLightShape1" -p "aiSkyDomeLight1";
	...
	setAttr -k off ".v";
	setAttr ".sc" -type "float3" 1 0.70500004 0.70500004 ;
	setAttr ".intensity" 0.10000000149011612;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "B0A0B3B2-4B81-2B4A-22FD-EB9F30B96850";
	setAttr -s 9 ".lnk";
	setAttr -s 9 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "3D2403B0-4109-045A-71FA-14881DFDF6DA";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "BD9CB53F-41FD-47DE-F95D-F7B36B0A2D04";
createNode displayLayerManager -n "layerManager";
	rename -uid "C53DC561-4369-E8E7-B2D6-A7B96F2F58D4";
createNode displayLayer -n "defaultLayer";
	rename -uid "4A8DD7B2-45E5-17CB-0407-41A17C9826CB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "11FB8079-42F5-D989-0BD5-07BED400D151";
...
createNode animCurveTA -n "Spinny_Guy_rotateY";
	...
	setAttr ".tan" 2;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 0 72 360;
	setAttr ".pre" 3;
	setAttr ".pst" 3;
...
createNode reference -n "GratePanelingRN";
	rename -uid "A26A5882-4B9C-65ED-3837-15AA87F0D3CC";
	setAttr -s 10 ".phl";
	setAttr ".phl[1]" 0;
	setAttr ".phl[2]" 0;
	setAttr ".phl[3]" 0;
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"GratePanelingRN" 0
		"GratePanelingRN" 22
		0 "|GratePaneling:TextureControl" "|Spinny_Guy" "-s -r "
		2 "|Spinny_Guy|GratePaneling:TextureControl" "translate" " -type \"double3\" 0 6.99451707088841612 0"
		
		2 "|Spinny_Guy|GratePaneling:TextureControl" "rotate" " -type \"double3\" 0 90 64.76642445361960654"
		
		2 "|Spinny_Guy|GratePaneling:TextureControl" "scale" " -type \"double3\" 34.68726963956095233 34.68726963956095233 34.68726963956095233"
		
		2 "|Spinny_Guy|GratePaneling:TextureControl" "rotatePivot" " -type \"double3\" 0 -1.9036316235608659 0"
		
		2 "|Spinny_Guy|GratePaneling:TextureControl" "rotatePivotTranslate" " -type \"double3\" 1.14808663919165221 0.38517502980172991 0"
		
		2 "|Spinny_Guy|GratePaneling:TextureControl" "scalePivot" " -type \"double3\" 0 -0.14175473191986415 0"
		
		2 "|Spinny_Guy|GratePaneling:TextureControl" "scalePivotTranslate" " -type \"double3\" 0 -1.7618768916410017 0"
		
		2 "|Spinny_Guy|GratePaneling:TextureControl|GratePaneling:FloorGrate" "translate" 
		" -type \"double3\" 0 -0.30911341293757721 0"
		2 "|Spinny_Guy|GratePaneling:TextureControl|GratePaneling:FloorGrate" "rotate" 
		" -type \"double3\" 0 0 0"
		2 "|Spinny_Guy|GratePaneling:TextureControl|GratePaneling:FloorGrate" "rotatePivotTranslate" 
		" -type \"double3\" 0 0 0"
		2 "|Spinny_Guy|GratePaneling:TextureControl|GratePaneling:FloorGrate2" "scale" 
		" -type \"double3\" 0.31592998588034343 0.31592998588034343 0.31592998588034343"
		3 "|Spinny_Guy|GratePaneling:TextureControl|GratePaneling:FloorGrate1|GratePaneling:FloorGrate1Shape.instObjGroups" 
		"GratePaneling:set4.dagSetMembers" "-na"
		3 "|Spinny_Guy|GratePaneling:TextureControl|GratePaneling:FloorGrate2|GratePaneling:FloorGrate2Shape.instObjGroups" 
		"GratePaneling:set4.dagSetMembers" "-na"
		3 "|Spinny_Guy|GratePaneling:TextureControl|GratePaneling:FloorGrate|GratePaneling:FloorGrateShape.instObjGroups" 
		"GratePaneling:set4.dagSetMembers" "-na"
		5 4 "GratePanelingRN" "|Spinny_Guy|GratePaneling:TextureControl|GratePaneling:FloorGrate.visibility" 
		"GratePanelingRN.placeHolderList[1]" ""
		5 4 "GratePanelingRN" "|Spinny_Guy|GratePaneling:TextureControl|GratePaneling:FloorGrate1.visibility" 
		"GratePanelingRN.placeHolderList[2]" ""
		5 4 "GratePanelingRN" "|Spinny_Guy|GratePaneling:TextureControl|GratePaneling:FloorGrate2.visibility" 
		"GratePanelingRN.placeHolderList[3]" ""
		5 4 "GratePanelingRN" "|Spinny_Guy|GratePaneling:TextureControl|GratePaneling:FloorGrate3.visibility" 
		"GratePanelingRN.placeHolderList[4]" ""
		5 0 "GratePanelingRN" "|Spinny_Guy|GratePaneling:TextureControl|GratePaneling:FloorGrate|GratePaneling:FloorGrateShape.instObjGroups" 
		"GratePaneling:set1.dagSetMembers" "GratePanelingRN.placeHolderList[5]" "GratePanelingRN.placeHolderList[6]" 
		"GratePaneling:set4.dsm"
		5 0 "GratePanelingRN" "|Spinny_Guy|GratePaneling:TextureControl|GratePaneling:FloorGrate1|GratePaneling:FloorGrate1Shape.instObjGroups" 
		"GratePaneling:set2.dagSetMembers" "GratePanelingRN.placeHolderList[7]" "GratePanelingRN.placeHolderList[8]" 
		"GratePaneling:set4.dsm"
		5 0 "GratePanelingRN" "|Spinny_Guy|GratePaneling:TextureControl|GratePaneling:FloorGrate2|GratePaneling:FloorGrate2Shape.instObjGroups" 
		"GratePaneling:set3.dagSetMembers" "GratePanelingRN.placeHolderList[9]" "GratePanelingRN.placeHolderList[10]" 
		"GratePaneling:set4.dsm";
...
select -ne :hardwareRenderGlobals;
	setAttr ".ctrs" 256;
	setAttr ".btrs" 512;
connectAttr "FloorGrate_visibility.o" "GratePanelingRN.phl[1]";
connectAttr "FloorGrate1_visibility.o" "GratePanelingRN.phl[2]";
connectAttr "FloorGrate2_visibility.o" "GratePanelingRN.phl[3]";
connectAttr "FloorGrate3_visibility.o" "GratePanelingRN.phl[4]";
connectAttr "GratePanelingRN.phl[5]" "GratePanelingRN.phl[6]";
connectAttr "GratePanelingRN.phl[7]" "GratePanelingRN.phl[8]";
connectAttr "GratePanelingRN.phl[9]" "GratePanelingRN.phl[10]";
