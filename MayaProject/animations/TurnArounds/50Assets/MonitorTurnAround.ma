...
//Name: MonitorTurnAround.ma
//Last modified: Mon, Mar 09, 2026 10:23:56 PM
//Codeset: 1252
file -rdi 1 -ns "Monitor" -rfn "MonitorRN" -op "v=0;" -typ "mayaAscii" "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Sci-Fi/Props/Tech/Monitor/Monitor.ma";
file -r -ns "Monitor" -dr 1 -rfn "MonitorRN" -op "v=0;" -typ "mayaAscii" "D:/Git Repository/UVU-AGD-Strm-Repo/MayaProject//assets/Sci-Fi/Props/Tech/Monitor/Monitor.ma";
...
fileInfo "UUID" "A4A50C55-43F5-B4E7-1377-AAA398135B02";
createNode transform -s -n "persp";
	rename -uid "09931983-4D12-26EA-F62F-C68A0E86A1FA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 21.463080477274072 12.373307014429972 18.864103406898799 ;
	setAttr ".r" -type "double3" 342.59999999961445 -313.19999999999703 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 20000;
	setAttr ".coi" 28.955644546338679;
...
createNode transform -n "QuartersCam" -p "Cameras";
	...
	setAttr ".t" -type "double3" -9.3334083650865516 3.86142258706482 -6.5151539824957192 ;
...
createNode camera -n "QuartersCamShape" -p "QuartersCam";
	...
	setAttr ".fcp" 20000;
	setAttr ".coi" 12.480323225460856;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
...
createNode aiSkyDomeLight -n "aiSkyDomeLightShape1" -p "aiSkyDomeLight1";
	...
	setAttr -k off ".v";
	setAttr ".sc" -type "float3" 0.461 0.2245 0.28909999 ;
	setAttr ".intensity" 0.10000000149011612;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "2600EA6E-40C9-8D31-96E7-3CB63685027B";
	setAttr -s 20 ".lnk";
	setAttr -s 20 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "F1D5EB11-494D-3D73-9190-6787D12A580A";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "59A35B1E-4DF0-B2C8-6F9F-6AA834A01E07";
createNode displayLayerManager -n "layerManager";
	rename -uid "2CFD405E-48F6-A55D-648C-68AF99A8B32F";
createNode displayLayer -n "defaultLayer";
	rename -uid "4A8DD7B2-45E5-17CB-0407-41A17C9826CB";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "1CD3C275-44F4-5E00-2CF4-3D879DC21C1C";
...
createNode reference -n "MonitorRN";
	rename -uid "8FD68AFE-464D-AA6E-BF95-23B1F43309BE";
	setAttr -s 2 ".phl";
	setAttr ".phl[1]" 0;
	setAttr ".phl[2]" 0;
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"MonitorRN" 0
		"MonitorRN" 11
		0 "|Monitor:ScifiMonitor" "|Spinny_Guy" "-s -r "
		0 "|Monitor:Old" "|Spinny_Guy" "-s -r "
		2 "|Spinny_Guy|Monitor:Old" "translate" " -type \"double3\" 9.12691497802734375 0.19271072342314177 -14.34584426879882812"
		
		2 "|Spinny_Guy|Monitor:Old" "rotate" " -type \"double3\" 0 169.09715700763555901 0"
		
		2 "|Spinny_Guy|Monitor:Old" "scale" " -type \"double3\" 0.99617394094461642 0.99617394094461642 0.99617394094461642"
		
		2 "|Spinny_Guy|Monitor:Old" "rotatePivotTranslate" " -type \"double3\" 0 0 0"
		
		2 "|Spinny_Guy|Monitor:ScifiMonitor" "translate" " -type \"double3\" 0 4.12838708998017445 0"
		
		2 "|Spinny_Guy|Monitor:ScifiMonitor" "rotate" " -type \"double3\" 0 170.488476607280802 0"
		
		2 "|Spinny_Guy|Monitor:ScifiMonitor" "scale" " -type \"double3\" 0.45683794561469204 0.45683794561469204 0.45683794561469204"
		
		5 4 "MonitorRN" "|Spinny_Guy|Monitor:ScifiMonitor.visibility" "MonitorRN.placeHolderList[1]" 
		""
		5 4 "MonitorRN" "|Spinny_Guy|Monitor:Old.visibility" "MonitorRN.placeHolderList[2]" 
		"";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
createNode animCurveTU -n "ScifiMonitor_visibility";
	rename -uid "3861C8B0-4C18-8B0D-A8C7-958DD60376E3";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 1 144 0;
	setAttr -s 2 ".kot[0:1]"  5 5;
createNode animCurveTU -n "Old_visibility";
	rename -uid "A27E2924-4848-B89A-102C-89932F23887D";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  144 0 145 1 288 1;
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "ScifiMonitor_visibility.o" "MonitorRN.phl[1]";
connectAttr "Old_visibility.o" "MonitorRN.phl[2]";
