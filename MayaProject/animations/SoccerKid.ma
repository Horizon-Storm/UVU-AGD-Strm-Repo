...
//Name: SoccerKid.ma
//Last modified: Sat, Dec 06, 2025 04:24:42 PM
//Codeset: 1252
...
fileInfo "UUID" "417C6948-4FF8-92C2-A6C0-29A30C04B427";
createNode transform -s -n "persp";
	rename -uid "8435EAF3-4591-5A8A-0FCE-B9ACE76A9A57";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -72.304498940931254 83.61477669750218 -22.171550132142265 ;
	setAttr ".r" -type "double3" -47.738352729538924 -95.000000000001819 -2.5444437451708134e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "1DF317E5-4585-CA2F-6D06-BFAA810FCD41";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".fcp" 20000;
	setAttr ".coi" 113.7031184078847;
...
createNode camera -n "MainCamShape" -p "MainCam";
	...
	setAttr ".fl" 34.999999999999993;
	setAttr ".fcp" 20000;
	setAttr ".coi" 65.713171844720875;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "BE409934-4B75-402B-E65C-F2B8617B2BC2";
	setAttr -s 10 ".lnk";
	setAttr -s 10 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "49C46725-4F91-51A3-8778-83A28B4C515C";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 2 0 1 ;
	setAttr -s 2 ".bspr";
	setAttr -s 2 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "0B9BD5E3-443B-6D95-FC45-2F9387B40339";
createNode displayLayerManager -n "layerManager";
	rename -uid "1373CD61-43C8-DAB4-10BD-458598AB7349";
	setAttr ".cdl" 1;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "AFE26ADF-4FCE-5143-7BF9-9BABD57AC7F9";
...
createNode animCurveTL -n "Bony_Main_CNT_translateX";
	...
	setAttr ".tan" 28;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -0.21170541494171857 30 -0.46344125845806883
		 48 -0.46344125845806883;
	setAttr -s 3 ".kot[0:2]"  18 18 18;
createNode animCurveTL -n "Bony_Main_CNT_translateY";
	rename -uid "48ABB379-4F01-27A9-47E6-94BFDD08C58E";
	setAttr ".tan" 28;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0 30 0 48 0;
	setAttr -s 3 ".kot[0:2]"  18 18 18;
createNode animCurveTL -n "Bony_Main_CNT_translateZ";
	rename -uid "67822740-4FFA-9961-0084-0E9CFF4C65C7";
	setAttr ".tan" 28;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -10.162370796002723 30 -10.162370796002723
		 48 -10.162370796002723;
	setAttr -s 3 ".kot[0:2]"  18 18 18;
...
createNode animCurveTA -n "Bony_HeadC_rotateX";
	...
	setAttr -s 12 ".ktv[0:11]"  0 2.7737735274891642 10 -8.9654260891101103
		 ...
		 73 -44.360710731399337 75 -43.927443735430074 80 -80.426693855243684 85 -40.905294645744085
...
createNode animCurveTA -n "Bony_HeadC_rotateZ";
	...
	setAttr -s 12 ".ktv[0:11]"  0 0 10 0 30 0 48 0 60 -15.386616347657604
		 70 -33.862492195858032 73 -42.518845707542901 75 -12.092161466287669 80 -12.092161466287685
...
createNode animCurveTU -n "Bony_Main_CNT_GlobalScale";
	...
	setAttr ".tan" 28;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 1 30 1 48 1;
	setAttr -s 3 ".kot[0:2]"  18 18 18;
...
createNode animCurveTA -n "Bony_lClavicleC_rotateY";
	...
	setAttr -s 4 ".ktv[0:3]"  0 -27.883687686899378 48 -27.883687686899378
		 95 -27.883687686899378 100 23.741089862306922;
	setAttr -s 4 ".kot[0:3]"  18 18 18 18;
...
createNode animCurveTA -n "Bony_rWristFKC_rotateX";
	...
	setAttr -s 9 ".ktv[0:8]"  0 1.3019073645651071 20 -23.18229962597864
		 30 -13.246265097899288 40 -35.542600812350777 46 -13.00186563330368 48 -13.00186563330368
...
createNode animCurveTA -n "Bony_rFootIKC_rotateY";
	...
	setAttr -s 18 ".ktv[0:17]"  0 0 10 0 20 2.9920059619024251 30 1.4364017230377881
		 ...
		 85 -8.2697859850192028 90 -8.2697859850192028 94 -8.4655506540039784 102 -8.6103274471779727;
	setAttr -s 18 ".kot[0:17]"  18 18 18 18 18 18 18 18 
		18 18 18 18 18 18 18 18 18 18;
...
createNode animCurveTA -n "Bony_Spine02FKC_rotateY";
	...
	setAttr -s 10 ".ktv[0:9]"  0 0 10 0 48 0 74 0 80 0 85 -3.3759920747049899
		 94 -3.3759920747049965 97 -3.3759920747050081 99 -3.3759920747050081 101 -3.3759920747050112;
	setAttr -s 10 ".kot[0:9]"  18 18 18 18 18 18 18 18 
		18 18;
...
createNode animCurveTA -n "Bony_rShoulderFKC_rotateX";
	...
	setAttr -s 14 ".ktv[0:13]"  0 1.4038760024286676 20 -31.6931369549715
		 30 -84.881670080209332 40 -22.450602490790331 46 -28.612339838219476 48 -1.6950913708221234
...
createNode animCurveTA -n "Bony_lWristFKC_rotateX";
	...
	setAttr -s 10 ".ktv[0:9]"  0 -8.164487708323092 20 -34.370989412463196
		 30 -13.827602511745983 40 -20.807550663090375 48 -2.653536955792215 80 -3.5521153291505683
...
createNode animCurveTA -n "Bony_Spine01FKC_rotateY";
	...
	setAttr -s 8 ".ktv[0:7]"  0 0 10 0 48 0 80 10.942504317037812 85 10.942504317037814
		 90 10.942504317037809 97 10.942504317037807 101 10.942504317037802;
	setAttr -s 8 ".kot[0:7]"  18 18 18 18 18 18 18 18;
...
createNode animCurveTL -n "Bony_Main_CNT_translateX1";
	...
	setAttr ".tan" 16;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  35 -11.224380996719541 48 -4.7327502030375728
		 53 -4.7476325653524079 65 -4.8040839065037027;
createNode animCurveTL -n "Bony_Main_CNT_translateY1";
	rename -uid "482229DE-4119-820D-7019-C4A0140B4B5D";
	setAttr ".tan" 16;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  35 0 48 0 53 0 65 0;
createNode animCurveTL -n "Bony_Main_CNT_translateZ1";
	rename -uid "428BB9AC-47B6-7BB1-DED7-8BBDC5CF1D1D";
	setAttr ".tan" 16;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  35 36.365398292327583 48 27.095557998051596
		 53 24.513709125995472 65 23.225670062900967;
...
createNode animCurveTA -n "Bony_Main_CNT_rotateY1";
	...
	setAttr ".tan" 16;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  35 172.40628476249802 48 156.69457392745943
		 53 159.97251074934312 65 172.40628476249802;
...
createNode animCurveTU -n "Bony_Main_CNT_GlobalScale1";
	...
	setAttr ".tan" 16;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  35 1 48 1 53 1 65 1;
